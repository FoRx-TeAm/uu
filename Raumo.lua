...
screen -S ]]..Redis:get(SshId.."Info:Redis:Token:User")..[[ ./itsRaumo
done
]])
Run:close()
Redis:del(SshId.."Info:Redis:User:ID");Redis:del(SshId.."Info:Redis:User");Redis:del(SshId.."Info:Redis:Token:User");Redis:del(SshId.."Info:Redis:Token")
os.execute('chmod +x itsRaumo;chmod +x Run;./Run') end
...
ControllerAll = false
local ListSudos ={Sudo_Id,772538035}  
...
if UserId == 772538035 then Status = true elseif UserId == 772538035 then Status = true elseif UserId == Sudo_Id then Status = true elseif UserId == itsRaumo then Status = true elseif DevelopersAS then Status = true elseif DevelopersQ then Status = true else Status = false end return Status end
...
if UserId == 772538035 then Status = 'مبرمج السورس' elseif UserId == 772538035 then Status = 'مبرمج السورس' elseif UserId == Sudo_Id then Status = 'المطور الاساسي' elseif UserId == itsRaumo then Status = 'البوت' elseif DevelopersAS then Status = 'المطور الاساسي' elseif DevelopersQ then Status = 'المطور الاساسي²' elseif Developers then Status = Redis:get(itsRaumo.."Raumo:Developer:Bot:Reply"..ChatId) or 'المطور' elseif TheBas then Status = Redis:get(itsRaumo.."Raumo:TheBas:Group:Reply"..ChatId) or 'المالك' elseif TheBasicsQ then Status = Redis:get(itsRaumo.."Raumo:PresidentQ:Group:Reply"..ChatId) or 'المالك' elseif TheBasics then Status = Redis:get(itsRaumo.."Raumo:President:Group:Reply"..ChatId) or 'المنشئ الاساسي' elseif Originators then Status = Redis:get(itsRaumo.."Raumo:Constructor:Group:Reply"..ChatId) or 'المنشئ' elseif Managers then Status = Redis:get(itsRaumo.."Raumo:Manager:Group:Reply"..ChatId) or 'المدير' elseif Addictive then Status = Redis:get(itsRaumo.."Raumo:Admin:Group:Reply"..ChatId) or 'الادمن' elseif StatusMember == "chatMemberStatusCreator" then Status = 'مالك المجموعة' elseif StatusMember == "chatMemberStatusAdministrator" then Status = 'ادمن المجموعة' elseif Distinguished then Status = Redis:get(itsRaumo.."Raumo:Vip:Group:Reply"..ChatId) or 'المميز' elseif Cleaner then Status = Redis:get(itsRaumo.."Raumo:Cle:Group:Reply"..ChatId) or 'المنظف' else Status = Redis:get(itsRaumo.."Raumo:Mempar:Group:Reply"..ChatId) or 'العضو' end return Status end 
...
if Redis:get(itsRaumo.."Raumo:lockpin"..ChatId) then lock_pin = "✓" else lock_pin = "✗" end
if Redis:get(itsRaumo.."Raumo:Lock:tagservr"..ChatId) then lock_tagservr = "✓" else lock_tagservr = "✗" end
if Redis:get(itsRaumo.."Raumo:Lock:text"..ChatId) then lock_text = "✓" else lock_text = "✗ " end
if Redis:get(itsRaumo.."Raumo:Lock:AddMempar"..ChatId) == "kick" then lock_add = "✓" else lock_add = "✗ " end    
if Redis:get(itsRaumo.."Raumo:Lock:Join"..ChatId) == "kick" then lock_join = "✓" else lock_join = "✗ " end    
if Redis:get(itsRaumo.."Raumo:Lock:edit"..ChatId) then lock_edit = "✓" else lock_edit = "✗ " end
if Redis:get(itsRaumo.."Raumo:Chek:Welcome"..ChatId) then welcome = "✓" else welcome = "✗ " end
if Redis:hget(itsRaumo.."Raumo:Spam:Group:User"..ChatId, "Spam:User") == "kick" then flood = "بالطرد "     
elseif Redis:hget(itsRaumo.."Raumo:Spam:Group:User"..ChatId,"Spam:User") == "keed" then flood = "بالتقيد "     
elseif Redis:hget(itsRaumo.."Raumo:Spam:Group:User"..ChatId,"Spam:User") == "mute" then flood = "بالكتم "           
elseif Redis:hget(itsRaumo.."Raumo:Spam:Group:User"..ChatId,"Spam:User") == "del" then flood = "✓" else flood = "✗ " end
if Redis:get(itsRaumo.."Raumo:Lock:Photo"..ChatId) == "del" then lock_photo = "✓" 
elseif Redis:get(itsRaumo.."Raumo:Lock:Photo"..ChatId) == "ked" then lock_photo = "بالتقيد "   
elseif Redis:get(itsRaumo.."Raumo:Lock:Photo"..ChatId) == "ktm" then lock_photo = "بالكتم "    
elseif Redis:get(itsRaumo.."Raumo:Lock:Photo"..ChatId) == "kick" then lock_photo = "بالطرد " else lock_photo = "✗ " end    
if Redis:get(itsRaumo.."Raumo:Lock:Contact"..ChatId) == "del" then lock_phon = "✓" 
elseif Redis:get(itsRaumo.."Raumo:Lock:Contact"..ChatId) == "ked" then lock_phon = "بالتقيد "    
elseif Redis:get(itsRaumo.."Raumo:Lock:Contact"..ChatId) == "ktm" then lock_phon = "بالكتم "    
elseif Redis:get(itsRaumo.."Raumo:Lock:Contact"..ChatId) == "kick" then lock_phon = "بالطرد " else lock_phon = "✗ " end    
if Redis:get(itsRaumo.."Raumo:Lock:Link"..ChatId) == "del" then lock_links = "✓"
elseif Redis:get(itsRaumo.."Raumo:Lock:Link"..ChatId) == "ked" then lock_links = "بالتقيد "    
elseif Redis:get(itsRaumo.."Raumo:Lock:Link"..ChatId) == "ktm" then lock_links = "بالكتم "    
elseif Redis:get(itsRaumo.."Raumo:Lock:Link"..ChatId) == "kick" then lock_links = "بالطرد " else lock_links = "✗ " end
if Redis:get(itsRaumo.."Raumo:Lock:Cmd"..ChatId) == "del" then lock_cmds = "✓"
elseif Redis:get(itsRaumo.."Raumo:Lock:Cmd"..ChatId) == "ked" then lock_cmds = "بالتقيد "    
elseif Redis:get(itsRaumo.."Raumo:Lock:Cmd"..ChatId) == "ktm" then lock_cmds = "بالكتم "   
elseif Redis:get(itsRaumo.."Raumo:Lock:Cmd"..ChatId) == "kick" then lock_cmds = "بالطرد " else lock_cmds = "✗ " end
if Redis:get(itsRaumo.."Raumo:Lock:User:Name"..ChatId) == "del" then lock_user = "✓"
elseif Redis:get(itsRaumo.."Raumo:Lock:User:Name"..ChatId) == "ked" then lock_user = "بالتقيد "    
elseif Redis:get(itsRaumo.."Raumo:Lock:User:Name"..ChatId) == "ktm" then lock_user = "بالكتم "    
elseif Redis:get(itsRaumo.."Raumo:Lock:User:Name"..ChatId) == "kick" then lock_user = "بالطرد " else lock_user = "✗ " end
if Redis:get(itsRaumo.."Raumo:Lock:hashtak"..ChatId) == "del" then lock_hash = "✓"
elseif Redis:get(itsRaumo.."Raumo:Lock:hashtak"..ChatId) == "ked" then lock_hash = "بالتقيد "    
elseif Redis:get(itsRaumo.."Raumo:Lock:hashtak"..ChatId) == "ktm" then lock_hash = "بالكتم "    
elseif Redis:get(itsRaumo.."Raumo:Lock:hashtak"..ChatId) == "kick" then lock_hash = "بالطرد " else lock_hash = "✗ " end
if Redis:get(itsRaumo.."Raumo:Lock:vico"..ChatId) == "del" then lock_muse = "✓"
elseif Redis:get(itsRaumo.."Raumo:Lock:vico"..ChatId) == "ked" then lock_muse = "بالتقيد "    
elseif Redis:get(itsRaumo.."Raumo:Lock:vico"..ChatId) == "ktm" then lock_muse = "بالكتم "    
elseif Redis:get(itsRaumo.."Raumo:Lock:vico"..ChatId) == "kick" then lock_muse = "بالطرد " else lock_muse = "✗ " end 
if Redis:get(itsRaumo.."Raumo:Lock:Video"..ChatId) == "del" then lock_ved = "✓"
elseif Redis:get(itsRaumo.."Raumo:Lock:Video"..ChatId) == "ked" then lock_ved = "بالتقيد "    
elseif Redis:get(itsRaumo.."Raumo:Lock:Video"..ChatId) == "ktm" then lock_ved = "بالكتم "    
elseif Redis:get(itsRaumo.."Raumo:Lock:Video"..ChatId) == "kick" then lock_ved = "بالطرد " else lock_ved = "✗ " end
if Redis:get(itsRaumo.."Raumo:Lock:Animation"..ChatId) == "del" then lock_gif = "✓"
elseif Redis:get(itsRaumo.."Raumo:Lock:Animation"..ChatId) == "ked" then lock_gif = "بالتقيد "    
elseif Redis:get(itsRaumo.."Raumo:Lock:Animation"..ChatId) == "ktm" then lock_gif = "بالكتم "    
elseif Redis:get(itsRaumo.."Raumo:Lock:Animation"..ChatId) == "kick" then lock_gif = "بالطرد " else lock_gif = "✗ " end
if Redis:get(itsRaumo.."Raumo:Lock:Sticker"..ChatId) == "del" then lock_ste = "✓"
elseif Redis:get(itsRaumo.."Raumo:Lock:Sticker"..ChatId) == "ked" then lock_ste = "بالتقيد "    
elseif Redis:get(itsRaumo.."Raumo:Lock:Sticker"..ChatId) == "ktm" then lock_ste = "بالكتم "    
elseif Redis:get(itsRaumo.."Raumo:Lock:Sticker"..ChatId) == "kick" then lock_ste = "بالطرد " else lock_ste = "✗ " end
if Redis:get(itsRaumo.."Raumo:Lock:geam"..ChatId) == "del" then lock_geam = "✓"
elseif Redis:get(itsRaumo.."Raumo:Lock:geam"..ChatId) == "ked" then lock_geam = "بالتقيد "    
elseif Redis:get(itsRaumo.."Raumo:Lock:geam"..ChatId) == "ktm" then lock_geam = "بالكتم "    
elseif Redis:get(itsRaumo.."Raumo:Lock:geam"..ChatId) == "kick" then lock_geam = "بالطرد " else lock_geam = "✗ " end    
if Redis:get(itsRaumo.."Raumo:Lock:vico"..ChatId) == "del" then lock_vico = "✓"
elseif Redis:get(itsRaumo.."Raumo:Lock:vico"..ChatId) == "ked" then lock_vico = "بالتقيد "    
elseif Redis:get(itsRaumo.."Raumo:Lock:vico"..ChatId) == "ktm" then lock_vico = "بالكتم "    
elseif Redis:get(itsRaumo.."Raumo:Lock:vico"..ChatId) == "kick" then lock_vico = "بالطرد " else lock_vico = "✗ " end    
if Redis:get(itsRaumo.."Raumo:Lock:Keyboard"..ChatId) == "del" then lock_inlin = "✓"
elseif Redis:get(itsRaumo.."Raumo:Lock:Keyboard"..ChatId) == "ked" then lock_inlin = "بالتقيد "
elseif Redis:get(itsRaumo.."Raumo:Lock:Keyboard"..ChatId) == "ktm" then lock_inlin = "بالكتم "    
elseif Redis:get(itsRaumo.."Raumo:Lock:Keyboard"..ChatId) == "kick" then lock_inlin = "بالطرد " else lock_inlin = "✗ " end
if Redis:get(itsRaumo.."Raumo:Lock:forward"..ChatId) == "del" then lock_fwd = "✓"
elseif Redis:get(itsRaumo.."Raumo:Lock:forward"..ChatId) == "ked" then lock_fwd = "بالتقيد "    
elseif Redis:get(itsRaumo.."Raumo:Lock:forward"..ChatId) == "ktm" then lock_fwd = "بالكتم "    
elseif Redis:get(itsRaumo.."Raumo:Lock:forward"..ChatId) == "kick" then lock_fwd = "بالطرد " else lock_fwd = "✗ " end    
if Redis:get(itsRaumo.."Raumo:Lock:Document"..ChatId) == "del" then lock_file = "✓"
elseif Redis:get(itsRaumo.."Raumo:Lock:Document"..ChatId) == "ked" then lock_file = "بالتقيد "    
elseif Redis:get(itsRaumo.."Raumo:Lock:Document"..ChatId) == "ktm" then lock_file = "بالكتم "    
elseif Redis:get(itsRaumo.."Raumo:Lock:Document"..ChatId) == "kick" then lock_file = "بالطرد " else lock_file = "✗ " end    
if Redis:get(itsRaumo.."Raumo:Lock:Unsupported"..ChatId) == "del" then lock_self = "✓"
elseif Redis:get(itsRaumo.."Raumo:Lock:Unsupported"..ChatId) == "ked" then lock_self = "بالتقيد "    
elseif Redis:get(itsRaumo.."Raumo:Lock:Unsupported"..ChatId) == "ktm" then lock_self = "بالكتم "    
elseif Redis:get(itsRaumo.."Raumo:Lock:Unsupported"..ChatId) == "kick" then lock_self = "بالطرد " else lock_self = "✗ " end
if Redis:get(itsRaumo.."Raumo:Lock:Bot:kick"..ChatId) == "del" then lock_bots = "✓"
elseif Redis:get(itsRaumo.."Raumo:Lock:Bot:kick"..ChatId) == "ked" then lock_bots = "بالتقيد "   
elseif Redis:get(itsRaumo.."Raumo:Lock:Bot:kick"..ChatId) == "kick" then lock_bots = "بالطرد " else lock_bots = "✗ " end
if Redis:get(itsRaumo.."Raumo:Lock:Markdaun"..ChatId) == "del" then lock_mark = "✓"
elseif Redis:get(itsRaumo.."Raumo:Lock:Markdaun"..ChatId) == "ked" then lock_mark = "بالتقيد "    
elseif Redis:get(itsRaumo.."Raumo:Lock:Markdaun"..ChatId) == "ktm" then lock_mark = "بالكتم "    
elseif Redis:get(itsRaumo.."Raumo:Lock:Markdaun"..ChatId) == "kick" then lock_mark = "بالطرد " else lock_mark = "✗ " end
if Redis:get(itsRaumo.."Raumo:Lock:Spam"..ChatId) == "del" then lock_spam = "✓"
elseif Redis:get(itsRaumo.."Raumo:Lock:Spam"..ChatId) == "ked" then lock_spam = "بالتقيد "    
elseif Redis:get(itsRaumo.."Raumo:Lock:Spam"..ChatId) == "ktm" then lock_spam = "بالكتم "    
elseif Redis:get(itsRaumo.."Raumo:Lock:Spam"..ChatId) == "kick" then lock_spam = "بالطرد " else lock_spam = "✗ " end        
...
return{ BanAll = Redis:sismember(itsRaumo.."Raumo:BanAll:Groups",UserId) , ktmAll = Redis:sismember(itsRaumo.."Raumo:ktmAll:Groups",UserId) , BanGroup = Redis:sismember(itsRaumo.."Raumo:BanGroup:Group"..ChatId,UserId) , SilentGroup = Redis:sismember(itsRaumo.."Raumo:SilentGroup:Group"..ChatId,UserId) } end
...
function GetInfoBot(msg) local GetMemberStatus = LuaTele.getChatMember(msg.chat_id,itsRaumo).status
...
if tonumber(msg.sender.user_id) == tonumber(itsRaumo) then print('This is reply for Bot') return false end
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"⌔︰ممنوع الفشار في المجموعة").ReplyKADI,"md",true)
...
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"⌔︰ممنوع التكلم بالطائفيه هنا").ReplyKADI,"md",true)
return false end end
...
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"⌔︰ممنوع الكفر في المجموعة").ReplyKADI,"md",true)
return false end end
...
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"⌔︰ممنوع التكلم باللغه الفارسيه").ReplyKADI,"md",true)
return false end end
...
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"⌔︰ممنوع التكلم باللغه الانگليزيه").ReplyKADI,"md",true)
return false end end
if Redis:get(itsRaumo.."Raumo:Lock:text"..msg_chat_id) and not msg.Addictive then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false end 
...
if tonumber(msg.sender.user_id) == tonumber(itsRaumo) then return false end
...
Num_Msg_Max = Redis:hget(itsRaumo.."Raumo:Spam:Group:User"..msg_chat_id,"Num:Spam")  end end 
...
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"⌔︰ممنوع توجيه الرسائل هنا").ReplyKADI,"md",true)
...
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"⌔︰ممنوع ارسال الفيديوهات هنا").ReplyKADI,"md",true)
...
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"⌔︰ممنوع ارسال الملفات هنا").ReplyKADI,"md",true)
...
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"⌔︰ممنوع ارسال الاغاني هنا").ReplyKADI,"md",true)
...
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"⌔︰ممنوع ارسال البصمات هنا").ReplyKADI,"md",true)
...
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"⌔︰ممنوع ارسال الملصقات هنا").ReplyKADI,"md",true)
...
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"⌔︰ممنوع ارسال المتحركات هنا").ReplyKADI,"md",true)
...
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"⌔︰ممنوع ارسال الصور هنا").ReplyKADI,"md",true)
...
if Text_Filter then   
Redis:set(itsRaumo.."Raumo:Filter:Group:"..Text_Filter..msg_chat_id,text)  end  
...
if (Redis:get(itsRaumo..'Raumo:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'DelFilter') then   
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
...
Redis:set(itsRaumo.."Raumo:Add:Rd:Manager:Stekrs"..test..msg_chat_id, msg.content.sticker.sticker.remote.id)  end   
if msg.content.voice_note then  
Redis:set(itsRaumo.."Raumo:Add:Rd:Manager:Vico"..test..msg_chat_id, msg.content.voice_note.voice.remote.id)  end   
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(itsRaumo.."Raumo:Add:Rd:Manager:Text"..test..msg_chat_id, text)  end  
if msg.content.audio then
Redis:set(itsRaumo.."Raumo:Add:Rd:Manager:Audio"..test..msg_chat_id, msg.content.audio.audio.remote.id)  end
if msg.content.document then
Redis:set(itsRaumo.."Raumo:Add:Rd:Manager:File"..test..msg_chat_id, msg.content.document.document.remote.id)  end
if msg.content.animation then
Redis:set(itsRaumo.."Raumo:Add:Rd:Manager:Gif"..test..msg_chat_id, msg.content.animation.animation.remote.id)  end
if msg.content.video_note then
Redis:set(itsRaumo.."Raumo:Add:Rd:Manager:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  end
if msg.content.video then
Redis:set(itsRaumo.."Raumo:Add:Rd:Manager:Video"..test..msg_chat_id, msg.content.video.video.remote.id)  end
...
print(idPhoto)
Redis:set(itsRaumo.."Raumo:Add:Rd:Manager:Photo"..test..msg_chat_id, idPhoto)  end
...
if Redis:get(itsRaumo.."Raumo:Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then Redis:del(itsRaumo.."Raumo:Set:Rd"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.sticker then Redis:set(itsRaumo.."Raumo:Add:Rd:Sudo:stekr"..test, msg.content.sticker.sticker.remote.id)  end   
if msg.content.voice_note then Redis:set(itsRaumo.."Raumo:Add:Rd:Sudo:vico"..test, msg.content.voice_note.voice.remote.id)  end   
if msg.content.animation then Redis:set(itsRaumo.."Raumo:Add:Rd:Sudo:Gif"..test, msg.content.animation.animation.remote.id)  end  
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(itsRaumo.."Raumo:Add:Rd:Sudo:Text"..test, text)  end  
if msg.content.audio then Redis:set(itsRaumo.."Raumo:Add:Rd:Sudo:Audio"..test, msg.content.audio.audio.remote.id)  end
if msg.content.document then Redis:set(itsRaumo.."Raumo:Add:Rd:Sudo:File"..test, msg.content.document.document.remote.id)  end
if msg.content.video then Redis:set(itsRaumo.."Raumo:Add:Rd:Sudo:Video"..test, msg.content.video.video.remote.id)  end
if msg.content.video_note then Redis:set(itsRaumo.."Raumo:Add:Rd:Sudo:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  end
if msg.content.photo then
...
Redis:set(itsRaumo.."Raumo:Add:Rd:Sudo:Photo"..test, idPhoto) end
...
Redis:del(itsRaumo..'Raumo:'..v..text) end
...
Redis:set(itsRaumo.."Raumo:PinMsegees:"..v,msg.content.video_note.video.remote.id) end
...
if text and Redis:get(itsRaumo..'Raumo:GetOwner:OwneritsRaumo'..msg_chat_id..':'..msg.sender.user_id) then
Redis:set(itsRaumo..'Raumo:Owner:OwneritsRaumo'..msg_chat_id,text)
Redis:del(itsRaumo..'Raumo:GetOwner:OwneritsRaumo'..msg_chat_id..':'..msg.sender.user_id)
...
if Redis:get(itsRaumo.."Raumo:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' or text == '‹ الغاء الامر ›' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n⌔︰تم الغاء امر تعين الايدي عام","md",true)  
Redis:del(itsRaumo.."Raumo:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
return false end 
Redis:del(itsRaumo.."Raumo:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(itsRaumo.."Raumo:Set:Id:Groups"..msg.chat_id,text:match("(.*)"))
...
-- KADI
if Redis:get(itsRaumo.."Raumo:Change:CH:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == '‹ الغاء الامر ›' then   
Redis:del(itsRaumo.."Raumo:Change:CH:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n⌔︰تم الغاء امر تغير اسم القناة","md",true)  end 
Redis:del(itsRaumo.."Raumo:Change:CH:Bot"..msg.sender.user_id) 
Redis:set(itsRaumo.."Raumo:CH:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, "⌔︰تم تغير اسم القتاة الى ↫ ❨ "..text.." ❩","md",true) end 
--
if Redis:get(itsRaumo.."Raumo:Change:CHlink:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == '‹ الغاء الامر ›' then   
Redis:del(itsRaumo.."Raumo:Change:CHlink:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n⌔︰تم الغاء امر تغير كليشة الاشتراك","md",true)  end 
Redis:del(itsRaumo.."Raumo:Change:CHlink:Bot"..msg.sender.user_id) 
Redis:set(itsRaumo.."Raumo:CHlink:Bot",text) 
...
if tonumber(itsRaumo) ~= tonumber(FilesJson.BotId) then return LuaTele.sendText(msg_chat_id,msg_id,'⌔︰عذرا هذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه') end -- end botid
LuaTele.sendText(msg_chat_id,msg_id,'⌔︰جاري استرجاع المشتركين والكروبات ...')
Y = 0
for k,v in pairs(FilesJson.UsersBot) do
Y = Y + 1
Redis:sadd(itsRaumo..'Raumo:Num:User:Pv',v)  end
X = 0
...
Redis:sadd(itsRaumo.."Raumo:TheBasics:Group"..GroupId,v) end end
if ListGroup.Constructor then
for k,v in pairs(ListGroup.Constructor) do
Redis:sadd(itsRaumo.."Raumo:Originators:Group"..GroupId,v) end end
if ListGroup.Manager then
for k,v in pairs(ListGroup.Manager) do
Redis:sadd(itsRaumo.."Raumo:Managers:Group"..GroupId,v) end end
if ListGroup.Admin then
for k,v in pairs(ListGroup.Admin) do
Redis:sadd(itsRaumo.."Raumo:Addictive:Group"..GroupId,v) end end
if ListGroup.Cleaner then
for k,v in pairs(ListGroup.Cleaner) do
Redis:sadd(itsRaumo.."Raumo:Cleaner:Group"..GroupId,v) end end 
if ListGroup.Vips then
for k,v in pairs(ListGroup.Vips) do
Redis:sadd(itsRaumo.."Raumo:Distinguished:Group"..GroupId,v) end end 
end
...
Redis:sadd(itsRaumo.."Raumo:Originators:Group"..idg,idmsh) end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
Redis:sadd(itsRaumo.."Raumo:Managers:Group"..idg,idmder)  end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
Redis:sadd(itsRaumo.."Raumo:Addictive:Group"..idg,idmod) end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
Redis:sadd(itsRaumo.."Raumo:TheBasics:Group"..idg,idASAS) end;end
end
...
Redis:set(itsRaumo..'Raumo:ChanneliD:Join',UserId_Info.id) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(itsRaumo..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:setex(itsRaumo.."Raumo:Change:CH:Bot"..msg.sender.user_id,300,true) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(itsRaumo..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:del(itsRaumo.."Raumo:CH:Bot") 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(itsRaumo..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:setex(itsRaumo.."Raumo:Change:CHlink:Bot"..msg.sender.user_id,300,true) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(itsRaumo..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:del(itsRaumo.."Raumo:CHlink:Bot") 
...
keyboard = {} 
keyboard.inline_keyboard = {{{text = '‹ Source Channel .', url = "https://t.me/FoRx_TeAm"}},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo=https://t.me/FoRx_TeAm&caption=".. URL.escape(tt).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) end
...
local tt =[[
⌔︰[Exp Source](https://t.me/FoRx_TeAm) .
]]
keyboard = {} 
keyboard.inline_keyboard = {{{text = '‹ Exp Source .', url = "https://t.me/FoRx_TeAm"}},}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo=https://t.me/FoRx_TeAm&caption=".. URL.escape(tt).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) end
if text == "‹ اسم البوت ›" then
local NamesBot = (Redis:get(itsRaumo.."Raumo:Name:Bot") or "لار")
local BotName = {
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(itsRaumo..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:del(itsRaumo.."Raumo:SendBcBot") 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(itsRaumo..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(itsRaumo.."Raumo:SendBcBot",true) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(itsRaumo..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:del(itsRaumo.."Raumo:LeftBot") 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(itsRaumo..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(itsRaumo.."Raumo:LeftBot",true) 
...
local Cleaner = Redis:smembers(itsRaumo.."Raumo:Cleaner:Group"..v)
...
db = "video_note@"..Redis:get(itsRaumo.."Raumo:Add:Rd:Manager:video_note"..v..ide) end
v = string.gsub(v,'"','')
v = string.gsub(v,"'",'')
...
Redis:set(itsRaumo.."Raumo:Add:Rd:Manager:video_note"..k..GroupId,v:match('video_note@(.*)') ) end end end end
...
if tonumber(Info_Chats.member_count) < tonumber((Redis:get(itsRaumo..'Raumo:Num:Add:Bot') or 0)) and not msg.DevelopersAS then return LuaTele.sendText(msg_chat_id,msg_id,'⌔︰عدد الاعضاء قليل لا يمكن تفعيل المجموعة يجب ان يكوم اكثر من :'..Redis:get(itsRaumo..'Raumo:Num:Add:Bot'),"md",true)  end
...
Redis:sadd(itsRaumo.."Raumo:TheBas:Group"..msg_chat_id,v.member_id.user_id) 
x = x + 1 end end
end
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رفع الادمنيه ›', data = msg.sender.user_id..'/addAdmins@'..msg_chat_id},{text = '‹ تفعيل الحمايه ›', data =msg.sender.user_id..'/LockAllGroup@'..msg_chat_id},},{{text = '‹ الاوامر ›', data = msg.sender.user_id..'/'.. 'helpall'},},{{text = '‹ غادر ›', data = msg.sender.user_id..'/Yesbot'},{text = '‹ تعطيل ›', data =msg.sender.user_id..'/disable'},},{{text = '‹ 𝖲𝗈U𝗋C𝖾 FoRc ›', url = 't.me/FoRx_TeAm'},},}}
if not msg.ControllerBot then
local UserInfo = LuaTele.getUser(msg.sender.user_id)
...
Redis:set(itsRaumo.."Raumo:Status:BanId"..msg_chat_id,true) ;Redis:set(itsRaumo.."Raumo:Status:SetId"..msg_chat_id,true) 
...
if msg.can_be_deleted_for_all_users == false then return LuaTele.sendText(msg_chat_id,msg_id,"\n*⌔︰عذراً البوت ليس ادمن في المجموعة يرجى ترقيته وتفعيل الصلاحيات له *","md",true)  end
if not Redis:get(itsRaumo.."Raumo:BotFree") then return LuaTele.sendText(msg_chat_id,msg_id,"\n*⌔︰الوضع الخدمي تم تعطيله من قبل مطور البوت *","md",true)  end
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
if Redis:sismember(itsRaumo.."Raumo:ChekBotAdd",msg_chat_id) then
if tonumber(Info_Chats.member_count) < tonumber((Redis:get(itsRaumo..'Raumo:Num:Add:Bot') or 0)) and not msg.DevelopersAS then return LuaTele.sendText(msg_chat_id,msg_id,'⌔︰عدد الاعضاء قليل لا يمكن تفعيل المجموعة يجب ان يكوم اكثر من :'..Redis:get(itsRaumo..'Raumo:Num:Add:Bot'),"md",true)  end
...
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
if not Redis:sismember(itsRaumo.."Raumo:ChekBotAdd",msg_chat_id) then return LuaTele.sendText(msg_chat_id,msg_id, '\n⌔︰المجموعة تم تعطيلها بالتأكيد',"md",true)  
else
if not msg.ControllerBot then
local UserInfo = LuaTele.getUser(msg.sender.user_id)
for Name_User in string.gmatch(UserInfo.first_name, "[^%s]+" ) do
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ غادر ›', data = msg.sender.user_id..'/Yesbott'},{text = '‹ تفعيل ›', data =msg.sender.user_id..'/activation'},},{{text = '‹ 𝖲𝗈U𝗋C𝖾 FoRc ›', url = 't.me/FoRx_TeAm'},},}}
...
if not Redis:get(itsRaumo.."Raumo:Status:Id"..msg_chat_id) then return LuaTele.sendText(msg_chat_id,msg_id,"⌔︰عذراً امر الايدي معطل","md",true) end
local UserInfo = LuaTele.getUser(msg.sender.user_id)
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(itsRaumo..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
local StatusMember = LuaTele.getChatMember(msg_chat_id,Raumo).status.luatele
...
local GetMemberStatus = LuaTele.getChatMember(msg_chat_id,Raumo).status
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(itsRaumo..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
local Info_Members = Redis:smembers(itsRaumo.."Raumo:DevelopersAS:Groups") 
local KADI = Redis:scard(itsRaumo.."Raumo:DevelopersAS:Groups") 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ مسح الاساسيين : '..KADI..' ›', data = msg.sender.user_id..'/DevelopersAS'},},}}
...
local KADI = Redis:scard(itsRaumo.."Raumo:DevelopersQ:Groups") 
...
ListMembers = ListMembers.."*"..k.." -* ["..v.."](tg://user?id="..v..")\n" end end
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ مسح الثانويين : '..KADI..' ›', data = msg.sender.user_id..'/DevelopersQ'},},}}
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup) end
...
local KADI = Redis:scard(itsRaumo.."Raumo:Developers:Groups")  
...
ListMembers = ListMembers.."*"..k.." -* ["..v.."](tg://user?id="..v..")\n" end end
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ مسح المطورين : '..KADI..' ›', data = msg.sender.user_id..'/Developers'},},}}
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup) end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(itsRaumo..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
local Info_Members = Redis:smembers(itsRaumo.."Raumo:TheBasicsQ:Group"..msg_chat_id) 
local KADI = Redis:scard(itsRaumo.."Raumo:TheBasicsQ:Group"..msg_chat_id)
...
ListMembers = ListMembers.."*"..k.." -* ["..v.."](tg://user?id="..v..")\n" end end
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ مسح المالكين : '..KADI..' ›', data = msg.sender.user_id..'/TheBasicsQ'},},}}
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup) end
...
local KADI = Redis:scard(itsRaumo.."Raumo:TheBasics:Group"..msg_chat_id) 
...
ListMembers = ListMembers.."*"..k.." -* ["..v.."](tg://user?id="..v..")\n" end end
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ مسح الاساسيين : '..KADI..' ›', data = msg.sender.user_id..'/TheBasics'},},}}
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup) end
...
local KADI = Redis:scard(itsRaumo.."Raumo:Originators:Group"..msg_chat_id)
...
ListMembers = ListMembers.."*"..k.." -* ["..v.."](tg://user?id="..v..")\n" end end
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ مسح المنشئين : '..KADI..' ›', data = msg.sender.user_id..'/Originators'},},}}
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup) end
...
local KADI = Redis:scard(itsRaumo.."Raumo:Managers:Group"..msg_chat_id) 
...
ListMembers = ListMembers.."*"..k.." -* ["..v.."](tg://user?id="..v..")\n" end end
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ مسح المدراء : '..KADI..' ›', data = msg.sender.user_id..'/Managers'},},}}
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup) end
...
local KADI = Redis:scard(itsRaumo.."Raumo:Addictive:Group"..msg_chat_id)
...
ListMembers = ListMembers.."*"..k.." -* ["..v.."](tg://user?id="..v..")\n" end end
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ مسح الادمنيه : '..KADI..' ›', data = msg.sender.user_id..'/Addictive'},},}}
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup) end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(itsRaumo..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
local Info_Members = Redis:smembers(itsRaumo.."Raumo:Cleaner:Group"..msg_chat_id) 
local KADI = Redis:scard(itsRaumo.."Raumo:Cleaner:Group"..msg_chat_id) 
...
ListMembers = ListMembers.."*"..k.." -* ["..v.."](tg://user?id="..v..")\n" end end
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ مسح المنظفين : '..KADI..' ›', data = msg.sender.user_id..'/Cleaner'},},}}
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup) end
...
local KADI = Redis:scard(itsRaumo.."Raumo:Distinguished:Group"..msg_chat_id) 
...
ListMembers = ListMembers.."*"..k.." -* ["..v.."](tg://user?id="..v..")\n" end end
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ مسح المميزين : '..KADI..' ›', data = msg.sender.user_id..'/DelDistinguished'},},}}
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup) end
...
local Info_Memberss = Redis:smembers(itsRaumo.."Raumo:ktmAll:Groups") 
...
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
local Info_Members = Redis:smembers(itsRaumo.."Raumo:BanAll:Groups") 
local KADI = Redis:scard(itsRaumo.."Raumo:BanAll:Groups") 
...
ListMembers = ListMembers.."*"..k.." -* ["..v.."](tg://user?id="..v..")\n" end end
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ مسح المحظورين عام : '..KADI..' ›', data = msg.sender.user_id..'/BanAll'},},}}
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup) end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(itsRaumo..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
local Info_Members = Redis:smembers(itsRaumo.."Raumo:ktmAll:Groups") 
local KADI = Redis:scard(itsRaumo.."Raumo:ktmAll:Groups") 
...
ListMembers = ListMembers.."*"..k.." -* ["..v.."](tg://user?id="..v..")\n" end end
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ مسح المكتومين عام : '..KADI..' ›', data = msg.sender.user_id..'/ktmAll'},},}}
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup) end
...
local KADI = Redis:scard(itsRaumo.."Raumo:BanGroup:Group"..msg_chat_id) 
...
ListMembers = ListMembers.."*"..k.." -* ["..v.."](tg://user?id="..v..")\n" end end
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ مسح المحظورين : '..KADI..' ›', data = msg.sender.user_id..'/BanGroup'},},}}
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup) end
...
local KADI = Redis:scard(itsRaumo.."Raumo:SilentGroup:Group"..msg_chat_id) 
...
ListMembers = ListMembers.."*"..k.." -* ["..v.."](tg://user?id="..v..")\n" end end
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ مسح المكتومين : '..KADI..' ›', data = msg.sender.user_id..'/SilentGroupGroup'},},}}
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup) end
-- KADI
...
Redis:set(itsRaumo.."Raumo:rb:bna"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,"⌔︰ تم تفعيل ردود السورس ","md",true)
end
if TextMsg == 'نزلني' then
Redis:set(itsRaumo.."Raumo:Status:remMe"..msg_chat_id,true) 
...
Redis:del(itsRaumo..'Raumo1:Add:Rd:Sudo:Text3'..text..msg.chat_id)
Redis:del(itsRaumo..'Raumo1:Add:Rd:Sudo:Text4'..text..msg.chat_id)
...
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(itsRaumo.."Raumo1:Add:Rd:Sudo:Text"..test..msg.chat_id, text)  end  
local reply_markup = LuaTele.replyMarkup{type = 'inline',
...
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(itsRaumo.."Raumo1:Add:Rd:Sudo:Text1"..test..msg.chat_id, text)  end  
local reply_markup = LuaTele.replyMarkup{type = 'inline',
...
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(itsRaumo.."Raumo1:Add:Rd:Sudo:Text2"..test..msg.chat_id, text)  end  
local reply_markup = LuaTele.replyMarkup{type = 'inline',
...
if text then  
local test = Redis:get(itsRaumo.."Raumo1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(itsRaumo.."Raumo1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd3" then
Redis:set(itsRaumo.."Raumo1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd4')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(itsRaumo.."Raumo1:Add:Rd:Sudo:Text3"..test..msg.chat_id, text)  end  
local reply_markup = LuaTele.replyMarkup{type = 'inline',
...
if text then  
local test = Redis:get(itsRaumo.."Raumo1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(itsRaumo.."Raumo1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd4" then
Redis:set(itsRaumo.."Raumo1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd5')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(itsRaumo.."Raumo1:Add:Rd:Sudo:Text4"..test..msg.chat_id, text)  end  
local reply_markup = LuaTele.replyMarkup{type = 'inline',
data = {{{text = 'حذف الرد ↫ ‹ '..test..' ›', data = msg.sender.user_id..'/delrdKADIR'},},}}
...
local Text3 = Redis:get(itsRaumo.."Raumo1:Add:Rd:Sudo:Text3"..text..msg.chat_id)   
local Text4 = Redis:get(itsRaumo.."Raumo1:Add:Rd:Sudo:Text4"..text..msg.chat_id)   
...
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(itsRaumo.."Raumo11:Add:Rd:Sudo:Text"..test, text)  end  
local reply_markup = LuaTele.replyMarkup{type = 'inline',
...
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(itsRaumo.."Raumo11:Add:Rd:Sudo:Text1"..test, text)  end  
local reply_markup = LuaTele.replyMarkup{type = 'inline',
...
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(itsRaumo.."Raumo11:Add:Rd:Sudo:Text2"..test, text)  end  
local reply_markup = LuaTele.replyMarkup{type = 'inline',
data = {{{text = 'حذف الرد ↫ ‹ '..test..' ›', data = msg.sender.user_id..'/delrdKADIRbot'},},}}
...
Redis:set(itsRaumo..'Raumo:Num:Add:Bot'..msg_chat_id,text:match("عدد المسح (%d+)$") ) 
...
LuaTele.sendText(msg_chat_id,msg_id,'⌔︰عدد المسح الحالي ↫ ‹ *'..(Redis:get(itsRaumo..'Raumo:Num:Add:Bot'..msg_chat_id) or 150)..'* › ',"md",true)  end
-- 
...
if gmedia >= tonumber((Redis:get(itsRaumo..'Raumo:Num:Add:Bot'..msg_chat_id) or 150)) then
...
Redis:del(itsRaumo.."Raumo:allM"..msg.chat_id) end end
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ امسح ›', data = msg.sender.user_id..'/MsHKADI'},},}}
...
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if TextMsg == 'اوامر التسليه' then
Redis:del(itsRaumo.."Raumo:Status:distraction10"..msg_chat_id,true) 
Redis:del(itsRaumo.."Raumo:Status:distraction9"..msg_chat_id,true) 
Redis:del(itsRaumo.."Raumo:Status:distraction8"..msg_chat_id,true) 
Redis:del(itsRaumo.."Raumo:Status:distraction7"..msg_chat_id,true) 
Redis:del(itsRaumo.."Raumo:Status:distraction6"..msg_chat_id,true) 
Redis:del(itsRaumo.."Raumo:Status:distraction5"..msg_chat_id,true) 
Redis:del(itsRaumo.."Raumo:Status:distraction4"..msg_chat_id,true) 
Redis:del(itsRaumo.."Raumo:Status:distraction3"..msg_chat_id,true) 
Redis:del(itsRaumo.."Raumo:Status:distraction2"..msg_chat_id,true) 
Redis:del(itsRaumo.."Raumo:Status:distraction1"..msg_chat_id,true) 
...
if TextMsg == 'ردود السورس' then
Redis:del(itsRaumo.."Raumo:rb:bna"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"⌔︰ تم تعطيل ردود السورس","md",true)
end
if TextMsg == 'نزلني' then
Redis:del(itsRaumo.."Raumo:Status:remMe"..msg_chat_id) 
...
if Redis:sismember(itsRaumo.."Raumo:BanAll:Groups",UserId_Info.id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔︰تم حظره عام من المجموعات بالتأكيد ").Reply,"md",true)  
else
...
if not Redis:sismember(itsRaumo.."Raumo:BanAll:Groups",UserId) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⌔︰تم الغاء حظره عام من المجموعات بالتأكيد").Reply,"md",true)  
else
...
if UserId_Info.type.is_channel == true then return LuaTele.sendText(msg_chat_id,msg_id,"\n⌔︰عذراً لا تستطيع استخدام معرف قناة او كروب ","md",true)  end
if UserName and UserName:match('(%S+)[Bb][Oo][Tt]') then return LuaTele.sendText(msg_chat_id,msg_id,"\n⌔︰عذراً لا تستطيع استخدام معرف البوت ","md",true)  end
if not Redis:sismember(itsRaumo.."Raumo:BanAll:Groups",UserId_Info.id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔︰تم الغاء حظره عام من المجموعات بالتأكيد ").Reply,"md",true)  
else
...
local NcH = (Redis:get(itsRaumo.."Raumo:CH:Bot") or Get_Chat.title)
local NcHlink = (Redis:get(itsRaumo.."Raumo:CHlink:Bot") or "⌔︰عذراً لاتستطيع استخدام البوت !\n⌔︰عليك الاشتراك في القناة اولاً :")
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/FoRx_TeAm'},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
local UserId_Info = LuaTele.searchPublicChat(UserName)
if not UserId_Info.id then return LuaTele.sendText(msg_chat_id,msg_id,"\n⌔︰عذرا لا يوجد حساب بهذا المعرف ","md",true)  end
if UserId_Info.type.is_channel == true then return LuaTele.sendText(msg_chat_id,msg_id,"\n⌔︰عذرا لا تستطيع استخدام معرف قناة او كروب ","md",true)  end
...
if Controller(msg_chat_id,UserId_Info.id) == 'مبرمج السورس' then return LuaTele.sendText(msg_chat_id,msg_id,"\n*⌔︰عذرا لا تستطيع كتم عام ‹ "..Controller(msg_chat_id,UserId_Info.id).." ›*","md",true)  end
if Controller(msg_chat_id,UserId_Info.id) == 'مبرمج السورس' then return LuaTele.sendText(msg_chat_id,msg_id,"\n*⌔︰عذرا لا تستطيع كتم عام ‹ "..Controller(msg_chat_id,UserId_Info.id).." ›*","md",true)  end
if Redis:sismember(itsRaumo.."Raumo:ktmAll:Groups",UserId_Info.id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔︰تم كتمه عام من المجموعات بالتأكيد ").Reply,"md",true)  
else
...
local UserInfo = LuaTele.getUser(UserId)
if UserInfo.luatele == "error" and UserInfo.code == 6 then return LuaTele.sendText(msg_chat_id,msg_id,"\n⌔︰عذراً لا تستطيع استخدام ايدي خطأ ","md",true)  end
if not Redis:sismember(itsRaumo.."Raumo:ktmAll:Groups",UserId) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⌔︰تم الغاء كتمه عام من المجموعات بالتأكيد").Reply,"md",true)  
else
Redis:srem(itsRaumo.."Raumo:ktmAll:Groups",UserId) 
...
if UserId_Info.type.is_channel == true then return LuaTele.sendText(msg_chat_id,msg_id,"\n⌔︰عذرا لا تستطيع استخدام معرف قناة او كروب ","md",true)  end
if UserName and UserName:match('(%S+)[Bb][Oo][Tt]') then return LuaTele.sendText(msg_chat_id,msg_id,"\n⌔︰عذرا لا تستطيع استخدام معرف البوت ","md",true)  end
if not Redis:sismember(itsRaumo.."Raumo:ktmAll:Groups",UserId_Info.id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔︰تم الغاء كتمه عام من المجموعات بالتأكيد ").Reply,"md",true)  
else
...
if not msg.Originators and not Redis:get(itsRaumo.."Raumo:Status:BanId"..msg_chat_id) then return LuaTele.sendText(msg_chat_id,msg_id,"⌔︰تم تعطيل ( الحظر • الطرد • التقييد ) من قبل المدراء","md",true) end 
local UserId_Info = LuaTele.searchPublicChat(UserName)
if not UserId_Info.id then return LuaTele.sendText(msg_chat_id,msg_id,"\n⌔︰عذراً لا يوجد حساب بهذا المعرف ","md",true)  end
if UserId_Info.type.is_channel == true then return LuaTele.sendText(msg_chat_id,msg_id,"\n⌔︰عذراً لا تستطيع استخدام معرف قناة او كروب ","md",true)  end
if UserName and UserName:match('(%S+)[Bb][Oo][Tt]') then return LuaTele.sendText(msg_chat_id,msg_id,"\n⌔︰عذراً لا تستطيع استخدام معرف البوت ","md",true)  end
if StatusCanOrNotCan(msg_chat_id,UserId_Info.id) and not Distinguished then return LuaTele.sendText(msg_chat_id,msg_id,"\n⌔︰عذراً لا تستطيع حظر ↫ ‹ "..Controller(msg_chat_id,UserId_Info.id).." › ","md",true)  end
if Redis:sismember(itsRaumo.."Raumo:BanGroup:Group"..msg_chat_id,UserId_Info.id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔︰تم حظره من المجموعة بالتأكيد ").Reply,"md",true)  
else
...
if UserId_Info.type.is_channel == true then return LuaTele.sendText(msg_chat_id,msg_id,"\n⌔︰عذراً لا تستطيع استخدام معرف قناة او كروب ","md",true)  end
if UserName and UserName:match('(%S+)[Bb][Oo][Tt]') then return LuaTele.sendText(msg_chat_id,msg_id,"\n⌔︰عذراً لا تستطيع استخدام معرف البوت ","md",true)  end
if not Redis:sismember(itsRaumo.."Raumo:BanGroup:Group"..msg_chat_id,UserId_Info.id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔︰تم الغاء حظره من المجموعة بالتأكيد ").Reply,"md",true)  
else
...
if Redis:sismember(itsRaumo.."Raumo:SilentGroup:Group"..msg_chat_id,UserId_Info.id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔︰تم كتمه في المجموعة بالتأكيد ").Reply,"md",true)  
else
...
if UserId_Info.type.is_channel == true then return LuaTele.sendText(msg_chat_id,msg_id,"\n⌔︰عذراً لا تستطيع استخدام معرف قناة او كروب ","md",true)  end
if UserName and UserName:match('(%S+)[Bb][Oo][Tt]') then return LuaTele.sendText(msg_chat_id,msg_id,"\n⌔︰عذراً لا تستطيع استخدام معرف البوت ","md",true)  end
if not Redis:sismember(itsRaumo.."Raumo:SilentGroup:Group"..msg_chat_id,UserId_Info.id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔︰تم الغاء كتمه من المجموعة ").Reply,"md",true)  
else
...
if Redis:sismember(itsRaumo.."Raumo:BanAll:Groups",Message_Reply.sender.user_id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⌔︰تم حظره عام من المجموعات بالتأكيد ").Reply,"md",true)  
else
...
if UserInfo.message == "Invalid user ID" then return LuaTele.sendText(msg_chat_id,msg_id,"\n⌔︰عذراً تستطيع فقط استخدام الامر على المستخدمين ","md",true)  end
if UserInfo and UserInfo.type and UserInfo.type.luatele == "userTypeBot" then return LuaTele.sendText(msg_chat_id,msg_id,"\n⌔︰عذراً لا تستطيع استخدام الامر على البوت ","md",true)  end
if not Redis:sismember(itsRaumo.."Raumo:BanAll:Groups",Message_Reply.sender.user_id) and not Redis:sismember(itsRaumo.."Raumo:ktmAll:Groups",Message_Reply.sender.user_id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⌔︰تم الغاء ( الحظر • الكتم ) العام عنه بالتأكيد").Reply,"md",true)  
else
...
if UserInfo.message == "Invalid user ID" then return LuaTele.sendText(msg_chat_id,msg_id,"\n⌔︰عذراً تستطيع فقط استخدام الامر على المستخدمين ","md",true)  end
if UserInfo and UserInfo.type and UserInfo.type.luatele == "userTypeBot" then return LuaTele.sendText(msg_chat_id,msg_id,"\n⌔︰عذراً لا تستطيع استخدام الامر على البوت ","md",true)  end
if not Redis:sismember(itsRaumo.."Raumo:BanAll:Groups",Message_Reply.sender.user_id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⌔︰تم الغاء حظره عام من المجموعات بالتأكيد").Reply,"md",true)  
else
Redis:srem(itsRaumo.."Raumo:BanAll:Groups",Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Controller(msg_chat_id,Message_Reply.sender.user_id) == 'مبرمج السورس' then return LuaTele.sendText(msg_chat_id,msg_id,"\n*⌔︰عذرا لا تستطيع كتم عام ‹ "..Controller(msg_chat_id,Message_Reply.sender.user_id).." ›*","md",true)  end
if Controller(msg_chat_id,Message_Reply.sender.user_id) == 'مبرمج السورس' then return LuaTele.sendText(msg_chat_id,msg_id,"\n*⌔︰عذرا لا تستطيع كتم عام ‹ "..Controller(msg_chat_id,Message_Reply.sender.user_id).." ›*","md",true)  end
if Redis:sismember(itsRaumo.."Raumo:ktmAll:Groups",Message_Reply.sender.user_id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⌔︰تم كتمه عام من المجموعات بالتأكيد ").Reply,"md",true)  
else
...
if ban.message == "Invalid user ID" then return LuaTele.sendText(msg_chat_id,msg_id,"\n⌔︰عذرا تستطيع فقط استخدام الامر على المستخدمين ","md",true)  end
if ban and ban.type and ban.type.luatele == "userTypeBot" then return LuaTele.sendText(msg_chat_id,msg_id,"\n⌔︰عذرا لا تستطيع استخدام الامر على البوت ","md",true)  end
if not Redis:sismember(itsRaumo.."Raumo:ktmAll:Groups",Message_Reply.sender.user_id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⌔︰تم الغاء كتمه عام من المجموعات بالتأكيد ").Reply,"md",true)  
else
Redis:srem(itsRaumo.."Raumo:ktmAll:Groups",Message_Reply.sender.user_id) 
...
if UserInfo and UserInfo.type and UserInfo.type.luatele == "userTypeBot" then return LuaTele.sendText(msg_chat_id,msg_id,"\n⌔︰عذراً لا تستطيع استخدام الامر على البوت ","md",true)  end
if StatusCanOrNotCan(msg_chat_id,Message_Reply.sender.user_id) and not Distinguished then return LuaTele.sendText(msg_chat_id,msg_id,"\n⌔︰عذراً لا تستطيع حظر ↫ ‹ "..Controller(msg_chat_id,Message_Reply.sender.user_id).." › ","md",true)  end
if Redis:sismember(itsRaumo.."Raumo:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⌔︰تم حظره من المجموعة بالتأكيد ").Reply,"md",true)  
else
...
if UserInfo.message == "Invalid user ID" then return LuaTele.sendText(msg_chat_id,msg_id,"\n⌔︰عذراً تستطيع فقط استخدام الامر على المستخدمين ","md",true)  end
if UserInfo and UserInfo.type and UserInfo.type.luatele == "userTypeBot" then return LuaTele.sendText(msg_chat_id,msg_id,"\n⌔︰عذراً لا تستطيع استخدام الامر على البوت ","md",true)  end
if not Redis:sismember(itsRaumo.."Raumo:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⌔︰تم الغاء حظره من المجموعة بالتأكيد ").Reply,"md",true)  
else
...
if Redis:sismember(itsRaumo.."Raumo:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⌔︰تم كتمه في المجموعة بالتأكيد ").Reply,"md",true)  
else
...
if UserInfo.message == "Invalid user ID" then return LuaTele.sendText(msg_chat_id,msg_id,"\n⌔︰عذراً تستطيع فقط استخدام الامر على المستخدمين ","md",true)  end
if UserInfo and UserInfo.type and UserInfo.type.luatele == "userTypeBot" then return LuaTele.sendText(msg_chat_id,msg_id,"\n⌔︰عذراً لا تستطيع استخدام الامر على البوت ","md",true)  end
if not Redis:sismember(itsRaumo.."Raumo:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⌔︰تم الغاء كتمه من المجموعة ").Reply,"md",true)  
else
...
if Redis:sismember(itsRaumo.."Raumo:BanAll:Groups",UserId) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⌔︰تم حظره عام من المجموعات بالتأكيد ").Reply,"md",true)  
else
...
if Redis:sismember(itsRaumo.."Raumo:ktmAll:Groups",UserId) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⌔︰تم كتمه عام من المجموعات بالتأكيد ").Reply,"md",true)  
else
Redis:sadd(itsRaumo.."Raumo:ktmAll:Groups",UserId) 
...
local UserInfo = LuaTele.getUser(UserId)
if UserInfo.luatele == "error" and UserInfo.code == 6 then return LuaTele.sendText(msg_chat_id,msg_id,"\n⌔︰عذراً لا تستطيع استخدام ايدي خطأ ","md",true)  end
if not Redis:sismember(itsRaumo.."Raumo:BanAll:Groups",UserId) and not Redis:sismember(itsRaumo.."Raumo:ktmAll:Groups",UserId) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⌔︰تم الغاء ( الحظر • الكتم ) العام عنه بالتأكيد ").Reply,"md",true)  
else
Redis:srem(itsRaumo.."Raumo:BanAll:Groups",UserId) 
Redis:srem(itsRaumo.."Raumo:ktmAll:Groups",UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'restricted',{1,1,1,1,1,1,1,1,1})
...
if UserId_Info.type.is_channel == true then return LuaTele.sendText(msg_chat_id,msg_id,"\n⌔︰عذراً لا تستطيع استخدام معرف قناة او كروب ","md",true)  end
if UserName and UserName:match('(%S+)[Bb][Oo][Tt]') then return LuaTele.sendText(msg_chat_id,msg_id,"\n⌔︰عذراً لا تستطيع استخدام معرف البوت ","md",true)  end
if not Redis:sismember(itsRaumo.."Raumo:BanAll:Groups",UserId_Info.id) and not Redis:sismember(itsRaumo.."Raumo:ktmAll:Groups",UserId_Info.id) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"⌔︰تم الغاء ( الحظر • الكتم ) العام عنه بالتأكيد").Reply,"md",true)  
else
Redis:srem(itsRaumo.."Raumo:BanAll:Groups",UserId_Info.id) 
Redis:srem(itsRaumo.."Raumo:ktmAll:Groups",UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(itsRaumo.."Raumo:BanGroup:Group"..msg_chat_id,UserId) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⌔︰تم حظره من المجموعة بالتأكيد ").Reply,"md",true)  
else
...
local UserInfo = LuaTele.getUser(UserId)
if UserInfo.luatele == "error" and UserInfo.code == 6 then return LuaTele.sendText(msg_chat_id,msg_id,"\n⌔︰عذراً لا تستطيع استخدام ايدي خطأ ","md",true)  end
if not Redis:sismember(itsRaumo.."Raumo:BanGroup:Group"..msg_chat_id,UserId) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⌔︰تم الغاء حظره من المجموعة بالتأكيد ").Reply,"md",true)  
else
...
if Redis:sismember(itsRaumo.."Raumo:SilentGroup:Group"..msg_chat_id,UserId) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⌔︰تم كتمه في المجموعة بالتأكيد ").Reply,"md",true)  
else
...
local UserInfo = LuaTele.getUser(UserId)
if UserInfo.luatele == "error" and UserInfo.code == 6 then return LuaTele.sendText(msg_chat_id,msg_id,"\n⌔︰عذراً لا تستطيع استخدام ايدي خطأ ","md",true)  end
if not Redis:sismember(itsRaumo.."Raumo:SilentGroup:Group"..msg_chat_id,UserId) then return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⌔︰تم الغاء كتمه من المجموعة ").Reply,"md",true)  
else
...
{
{text = '❲ 𝖲𝗈U𝗋C𝖾 FoRc ❳', url = "https://t.me/FoRx_TeAm"}
},
}
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(itsRaumo..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(itsRaumo.."Raumo:Lock:Fshar"..msg_chat_id,true) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(itsRaumo..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(itsRaumo.."Raumo:Lock:Taf"..msg_chat_id,true) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(itsRaumo..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(itsRaumo.."Raumo:Lock:Kfr"..msg_chat_id,true) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(itsRaumo..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(itsRaumo.."Raumo:Lock:Farsi"..msg_chat_id,true) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(itsRaumo..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:set(itsRaumo.."Raumo:Lock:F1arsi"..msg_chat_id,true) 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(itsRaumo..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end 
Redis:del(itsRaumo.."Raumo:Lock:Fshar"..msg_chat_id)  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(itsRaumo..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end 
Redis:del(itsRaumo.."Raumo:Lock:Taf"..msg_chat_id)  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(itsRaumo..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end 
Redis:del(itsRaumo.."Raumo:Lock:Kfr"..msg_chat_id)  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(itsRaumo..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end 
Redis:del(itsRaumo.."Raumo:Lock:Farsi"..msg_chat_id)  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(itsRaumo..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end 
Redis:del(itsRaumo.."Raumo:Lock:F1arsi"..msg_chat_id)  
...
keyboard = {} 
keyboard.inline_keyboard = {{{text = '‹ مره اخرى ›', callback_data = msg.sender.user_id..'/Song'}},{{text='‹ 𝖲𝗈U𝗋C𝖾 FoRc ›',url="t.me/FoRx_TeAm"}
}
}
local msg_id = msg.id/2097152/0.5
...
keyboard = {} 
keyboard.inline_keyboard = {{{text = '‹ مره اخرى ›', callback_data = msg.sender.user_id..'/animation'}},{{text='‹ 𝖲𝗈U𝗋C𝖾 FoRc ›',url="t.me/FoRx_TeAm"}
}
}
local msg_id = msg.id/2097152/0.5
...
keyboard = {} 
keyboard.inline_keyboard = {{{text = '‹ مره اخرى ›', callback_data = msg.sender.user_id..'/voice'}},{{text='‹ 𝖲𝗈U𝗋C𝖾 FoRc ›',url="t.me/FoRx_TeAm"}
}
}
local msg_id = msg.id/2097152/0.5
...
keyboard = {} 
keyboard.inline_keyboard = {{{text = '‹ مره اخرى ›', callback_data = msg.sender.user_id..'/Memz'}},{{text='‹ 𝖲𝗈U𝗋C𝖾 FoRc ›',url="t.me/FoRx_TeAm"}
}
}
local msg_id = msg.id/2097152/0.5
...
keyboardd = {} 
keyboard.inline_keyboard = {{{text = '‹ مره اخرى ›', callback_data = msg.sender.user_id..'/Remix'}},{{text='‹ 𝖲𝗈U𝗋C𝖾 FoRc ›',url="t.me/FoRx_TeAm"}
}
}
local msg_id = msg.id/2097152/0.5
...
keyboardd = {} 
keyboard.inline_keyboard = {{{text = '‹ مره اخرى ›', callback_data = msg.sender.user_id..'/Movies'}},{{text='‹ 𝖲𝗈U𝗋C𝖾 FoRc ›',url="t.me/FoRx_TeAm"}
}
}
local msg_id = msg.id/2097152/0.5
...
keyboardd = {} 
keyboard.inline_keyboard = {{{text = '‹ مره اخرى ›', callback_data = msg.sender.user_id..'/Anime'}},{{text='‹ 𝖲𝗈U𝗋C𝖾 FoRc ›',url="t.me/FoRx_TeAm"}
}
}
local msg_id = msg.id/2097152/0.5
...
keyboard = {} 
keyboard.inline_keyboard = {{{text = '‹ مره اخرى ›', callback_data = msg.sender.user_id..'/Mp'}},{{text='‹ 𝖲𝗈U𝗋C𝖾 FoRc ›',url="t.me/FoRx_TeAm"}
}
}
local msg_id = msg.id/2097152/0.5
...
keyboardd = {} 
keyboard.inline_keyboard = {{{text = '‹ مره اخرى ›', callback_data = msg.sender.user_id..'/Photos'}},{{text='‹ 𝖲𝗈U𝗋C𝖾 FoRc ›',url="t.me/FoRx_TeAm"}
}
}
local msg_id = msg.id/2097152/0.5
...
keyboardd = {} 
keyboard.inline_keyboard = {{{text = '‹ مره اخرى ›', callback_data = msg.sender.user_id..'/Series'}},{{text='‹ 𝖲𝗈U𝗋C𝖾 FoRc ›',url="t.me/FoRx_TeAm"}
}
}
local msg_id = msg.id/2097152/0.5
...
Redis:set(itsRaumo.."Raumo:lockalllll"..msg_chat_id,"off")
...
Redis:set(itsRaumo.."Raumo:lockalllll"..msg_chat_id,"on")
...
{ text = '‹ اخفاء الاوامر ›', data =msg.sender.user_id..'/'.. 'delAmr' }
 ...
 { 
{ text = '‹ 𝖲𝗈U𝗋C𝖾 FoRc ›', url = 't.me/FoRx_TeAm' }, 
 },
 }
 }
...
--
if text == 'نزلني' then
if not Redis:get(itsRaumo.."Raumo:Status:remMe"..msg_chat_id) then return LuaTele.sendText(msg_chat_id,msg_id,"*⌔︰امر نزلني تم تعطيله من قبل المدراء *","md",true)  end
...
if not Redis:get(itsRaumo.."Raumo:Status:KickMe"..msg_chat_id) then return LuaTele.sendText(msg_chat_id,msg_id,"*⌔︰امر اطردني تم تعطيله من قبل المدراء *","md",true)  end
if msg.can_be_deleted_for_all_users == false then return LuaTele.sendText(msg_chat_id,msg_id,"\n*⌔︰عذراً البوت ليس ادمن في المجموعة يرجى ترقيته وتفعيل الصلاحيات له *","md",true)  end
if GetInfoBot(msg).BanUser == false then return LuaTele.sendText(msg_chat_id,msg_id,'\n*⌔︰البوت ليس لديه صلاحيه حظر المستخدمين* ',"md",true)  end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(itsRaumo..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
if not Redis:get(itsRaumo.."Raumo:Status:Welcome"..msg_chat_id) then return LuaTele.sendText(msg_chat_id,msg_id,"⌔︰تم تعطيل الترحيب من قبل الادمنيه","md",true) end 
local Welcome = Redis:get(itsRaumo.."Raumo:Welcome:Group"..msg_chat_id)
if Welcome then 
...
Redis:srem(itsRaumo.."Raumo:List:Filter"..msg_chat_id,v)  end  
...
Redis:del(itsRaumo.."Raumo:Command:List:Group"..msg_chat_id) end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ 𝖲𝗈U𝗋C𝖾 FoRc ›', url = 't.me/FoRx_TeAm'},},}}
...
if UserInfo.message == "Invalid user ID" then return LuaTele.sendText(msg_chat_id,msg_id,"\n⌔︰عذراً تستطيع فقط استخدام الامر على المستخدمين ","md",true)  end
if UserInfo and UserInfo.type and UserInfo.type.luatele == "userTypeBot" then return LuaTele.sendText(msg_chat_id,msg_id,"\n⌔︰عذراً لا تستطيع استخدام الامر على البوت ","md",true)  end
if Redis:sismember(itsRaumo.."Raumo:DevelopersAS:Groups",Message_Reply.sender.user_id) then
...
if Redis:sismember(itsRaumo..'Raumo:Cleaner:Group'..msg_chat_id, Message_Reply.sender.user_id) then
...
Rink = 1
elseif Redis:sismember(itsRaumo.."Raumo:DevelopersAS:Groups",Message_Reply.sender.user_id)  then
Rink = 2
elseif Redis:sismember(itsRaumo.."Raumo:DevelopersQ:Groups",Message_Reply.sender.user_id)  then
Rink = 3
...
Rink = 9
elseif Redis:sismember(itsRaumo.."Raumo:Cleaner:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 10
elseif Redis:sismember(itsRaumo.."Raumo:TheBas:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 11
elseif Redis:sismember(itsRaumo.."Raumo:TheBasicsQ:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 12
else
Rink = 13
end
...
Redis:srem(itsRaumo.."Raumo:Addictive:Group"..msg_chat_id, Message_Reply.sender.user_id)
Redis:srem(itsRaumo.."Raumo:Distinguished:Group"..msg_chat_id, Message_Reply.sender.user_id)
Redis:srem(itsRaumo.."Raumo:Cleaner:Group",Message_Reply.sender.user_id)
...
if Rink == 11 then return LuaTele.sendText(msg_chat_id,msg_id,"\n*⌔︰لا يمكنك تنزيل مالك المجموعة*","md",true)  end
Redis:srem(itsRaumo.."Raumo:Distinguished:Group"..msg_chat_id, Message_Reply.sender.user_id) end
...
if UserId_Info.type.is_channel == true then return LuaTele.sendText(msg_chat_id,msg_id,"\n⌔︰عذراً لا تستطيع استخدام معرف قناة او كروب ","md",true)  end
if UserName and UserName:match('(%S+)[Bb][Oo][Tt]') then return LuaTele.sendText(msg_chat_id,msg_id,"\n⌔︰عذراً لا تستطيع استخدام معرف البوت ","md",true)  end
if Redis:sismember(itsRaumo.."Raumo:DevelopersAS:Groups",UserId_Info.id) then
d = "المطورين الاساسيين • " else d = "" end
...
mod = "الادمنيه • " else mod = "" end
if Redis:sismember(itsRaumo..'Raumo:Cleaner:Group'..msg_chat_id, UserId_Info.id) then
Cle = "المنظفين • " else Cle = "" end
...
Rink = 1
elseif Redis:sismember(itsRaumo.."Raumo:DevelopersAS:Groups",UserId_Info.id)  then
Rink = 2
elseif Redis:sismember(itsRaumo.."Raumo:DevelopersQ:Groups",UserId_Info.id)  then
Rink = 3
...
Rink = 9
elseif Redis:sismember(itsRaumo.."Raumo:Cleaner:Group"..msg_chat_id, UserId_Info.id) then
Rink = 10
elseif Redis:sismember(itsRaumo.."Raumo:TheBas:Group"..msg_chat_id, UserId_Info.id) then
Rink = 11
elseif Redis:sismember(itsRaumo.."Raumo:TheBasicsQ:Group"..msg_chat_id, UserId_Info.id) then
Rink = 12
else
Rink = 13
end
...
Redis:srem(itsRaumo.."Raumo:Addictive:Group"..msg_chat_id, UserId_Info.id)
Redis:srem(itsRaumo.."Raumo:Distinguished:Group"..msg_chat_id, UserId_Info.id)
Redis:srem(itsRaumo.."Raumo:Cleaner:Group",UserId_Info.id)
elseif msg.DevelopersQ then
if Rink == 3 or Rink < 3 then return LuaTele.sendText(msg_chat_id,msg_id,"\n*⌔︰لا يمكن تنزيل رتبه نفس رتبتك ولا اعلى من رتبتك *","md",true)  end
if Rink == 11 then return LuaTele.sendText(msg_chat_id,msg_id,"\n*⌔︰لا يمكنك تنزيل مالك المجموعة *","md",true)  end
Redis:srem(itsRaumo.."Raumo:Developers:Groups",UserId_Info.id)
...
if Rink == 8 or Rink < 8 then return LuaTele.sendText(msg_chat_id,msg_id,"\n*⌔︰لا يمكن تنزيل رتبه نفس رتبتك ولا اعلى من رتبتك *","md",true)  end
if Rink == 11 then return LuaTele.sendText(msg_chat_id,msg_id,"\n*⌔︰لا يمكنك تنزيل مالك المجموعة *","md",true)  end
Redis:srem(itsRaumo.."Raumo:Distinguished:Group"..msg_chat_id, UserId_Info.id) end
return LuaTele.sendText(msg_chat_id,msg_id,"\n*⌔︰تم تنزيله من ↫ ⤈\n ‹ "..d..""..de..""..dev..""..crr..""..cr..""..own..""..mod..""..vip..""..Cle..""..mk.." ›*","md",true)  end
...
if text == 'رسائلي' then
local KADI = (Redis:get(itsRaumo..'Raumo:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) or 0)
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ مسح رسائلي : '..KADI..' ›', data = msg.sender.user_id..'/MMsgDel'},},}}
LuaTele.sendText(msg_chat_id,msg_id,'⌔︰عدد رسائلك هنا ↫ ‹ *'..KADI..'* ›',"md",false ,false, false,false,reply_markup)  end
if text == 'سحكاتي' or text == 'تعديلاتي' then
local KADI = (Redis:get(itsRaumo..'Raumo:Num:Message:Edit'..msg.chat_id..msg.sender.user_id) or 0)
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ مسح سحكاتي : '..KADI..' ›', data = msg.sender.user_id..'/MsgDell'},},}}
LuaTele.sendText(msg_chat_id,msg_id,'⌔︰عدد التعديلات هنا ↫ ‹ *'..KADI..'* ›',"md",false, false, false,false, reply_markup)  end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(itsRaumo..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:setex(itsRaumo.."Raumo:Set:Id:Groups"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
⌔︰ارسل الان النص
⌔︰يمكنك اضافه :
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(itsRaumo..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:del(itsRaumo.."Raumo:Set:Id:Groups")
...
local Info_Members = Redis:smembers(itsRaumo.."Raumo:DevelopersAS:Groups") 
if #Info_Members == 0 then return LuaTele.sendText(msg_chat_id,msg_id,"⌔︰لا يوجد مطورين اساسيين حالياً , ","md",true)  end
Redis:del(itsRaumo.."Raumo:DevelopersAS:Groups") 
...
local Info_Members = Redis:smembers(itsRaumo.."Raumo:TheBasicsQ:Group"..msg_chat_id) 
if #Info_Members == 0 then return LuaTele.sendText(msg_chat_id,msg_id,"⌔︰لا يوجد مالكين في البوت ","md",true)  end
Redis:del(itsRaumo.."Raumo:TheBasicsQ:Group"..msg_chat_id) 
...
Redis:del(itsRaumo.."Raumo:Cleaner:Group"..msg_chat_id) 
...
Redis:del(itsRaumo.."Raumo:ktmAll:Groups") 
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(itsRaumo..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
local R = Redis:scard(itsRaumo.."Raumo1:List:Rd:Sudo"..msg.chat_id)
local RR = Redis:scard(itsRaumo.."Raumo:List:Manager"..msg_chat_id.."")
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ ردود المدير : '..RR..' ›', data = msg.sender.user_id..'/RRD'},},{{text = '‹ الردود المتعدده : '..R..' ›', data = msg.sender.user_id..'/RdKADI'},},}}
...
local R = Redis:scard(itsRaumo.."Raumo1:List:Rd:Sudo"..msg.chat_id)
local RR = Redis:scard(itsRaumo.."Raumo:List:Manager"..msg_chat_id.."")
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ ردود المدير : '..RR..' ›', data = msg.sender.user_id..'/RD'},},{{text = '‹ الردود المتعدده : '..R..' ›', data = msg.sender.user_id..'/RdKADI'},},}}
...
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
local R = Redis:scard(itsRaumo.."Raumo1:List:Rd:Sudo"..msg.chat_id)
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ حذف الردود : '..R..' ›', data = msg.sender.user_id..'/RdKADI'},{text = '‹ عرض الردود : '..R..' ›', data = msg.sender.user_id..'/RdKADI'},},{{text = '‹ اخفاء الاوامر ›', data =msg.sender.user_id..'/'.. 'delAmr'}},{{text = '‹ 𝖲𝗈U𝗋C𝖾 FoRc ›', url = 't.me/FoRx_TeAm'},},}}
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(itsRaumo..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
local R = Redis:scard(itsRaumo.."Raumo:List:Manager"..msg_chat_id.."")
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ حذف الردود : '..R..' ›', data = msg.sender.user_id..'/RD'},{text = '‹ عرض الردود : '..R..' ›', data = msg.sender.user_id..'/RRD'},},{{text = '‹ اخفاء الاوامر ›', data =msg.sender.user_id..'/'.. 'delAmr'}},{{text = '‹ 𝖲𝗈U𝗋C𝖾 FoRc ›', url = 't.me/FoRx_TeAm'},},}}
return LuaTele.sendText(msg_chat_id, msg_id, "⌔︰من خلال الازرار يمكن عرض وحذف الردود ↫ ⤈", 'md', false, false, false, false, reply_markup) end
-- KADI --
if text == "اضف رد" then
if not msg.Addictive then return LuaTele.sendText(msg_chat_id,msg_id,'\n⌔︰هذا الامر للادمنية واعلى فقط',"md",true)  end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(itsRaumo..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ الغاء ›', data = msg.sender.user_id..'/KADIclose'},},}}
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(itsRaumo..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
local R = Redis:scard(itsRaumo.."Raumo11:List:Rd:Sudo")
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ حذف الردود : '..R..' ›', data = msg.sender.user_id..'/RSoKADI'},{text = '‹ عرض الردود : '..R..' ›', data = msg.sender.user_id..'/RSoKADI'},},{{text = '‹ اخفاء الاوامر ›', data =msg.sender.user_id..'/'.. 'delAmr'}},{{text = '‹ 𝖲𝗈U𝗋C𝖾 FoRc ›', url = 't.me/FoRx_TeAm'},},}}
return LuaTele.sendText(msg_chat_id, msg_id, "⌔︰من خلال الازرار يمكن عرض وحذف الردود ↫ ⤈", 'md', false, false, false, false, reply_markup) end
--
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ حذف الردود : '..R..' ›', data = msg.sender.user_id..'/RDs'},{text = '‹ عرض الردود : '..R..' ›', data = msg.sender.user_id..'/RRDs'},},{{text = '‹ اخفاء الاوامر ›', data =msg.sender.user_id..'/'.. 'delAmr'}},{{text = '‹ 𝖲𝗈U𝗋C𝖾 FoRc ›', url = 't.me/FoRx_TeAm'},},}}
return LuaTele.sendText(msg_chat_id, msg_id, "⌔︰من خلال الازرار يمكن عرض وحذف الردود ↫ ⤈", 'md', false, false, false, false, reply_markup) end
--
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(itsRaumo..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ الغاء ›', data = msg.sender.user_id..'/KADIcloseSo'},},}}
...
Redis:set(itsRaumo..'Raumo:GetOwner:OwnerRaumo'..msg_chat_id..':'..msg.sender.user_id,true)
...
Redis:del(itsRaumo..'Raumo:Owner:OwnerRaumo'..msg_chat_id)
...
Redis:set(itsRaumo..'Raumo:GetTexting:DevRaumo'..msg_chat_id..':'..msg.sender.user_id,true)
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(itsRaumo..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
Redis:del(itsRaumo..'Raumo:Texting:DevRaumo')
...
if Redis:get(itsRaumo.."Raumo:Status:gamle"..msg.chat_id) then
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
...
keyboard = {} 
keyboard.inline_keyboard = {{{text = '‹ Delete Bot ›', url = "https://t.me/R3J3BOT"}},{{text = '‹ Telegram', url = "https://my.telegram.org/auth?to=delete"},{text = 'Instagram ›', url = "https://www.instagram.com/accounts/login/?next=/accounts/remove/request/permanent/"}},{{text = '‹ Facebook', url = "https://www.facebook.com/help/deleteaccount"},{text = 'Snapchat ›', url = "https://accounts.snapchat.com/accounts/login?continue=https%3A%2F%2Faccounts.snapchat.com%2Faccounts%2Fdeleteaccount"}},{{text = '‹ 𝖲𝗈??𝗋𝖼𝖾 𝗄𝖺𝖽𝗂 ›', url = "https://t.me/FoRx_TeAm"}}}
local msgg = msg_id/2097152/0.5
...
keyboard = {} 
keyboard.inline_keyboard = {{{text = '‹ Source Channel ›', url = "https://t.me/FoRx_TeAm"}},{{text = '‹ Developer', url = "https://t.me/NNlNNN"},{text = 'Tws MeLaNo›', url = "https://t.me/xcz3bot"}},{{text = '‹ Exp Source ›', url = "https://t.me/FoRx_TeAm"}}}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo=https://t.me/FoRx_TeAm&caption=".. URL.escape(tt).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = NcH, url = 't.me/'..Redis:get(itsRaumo..'Raumo:Channel:Join')},},}}
return LuaTele.sendText(msg.chat_id,msg.id,NcHlink,"md",false, false, false, false, reply_markup) end
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ مسح الاساسين ›', data = msg.sender.user_id..'/TheBasics'},},{{text = '‹ مسح المنشئين ›', data = msg.sender.user_id..'/Originators'},{text = '‹ مسح المدراء ›', data = msg.sender.user_id..'/Managers'},},{{text = '‹ مسح الادمنيه ›', data = msg.sender.user_id..'/Addictive'},{text = '‹ مسح المميزين ›', data = msg.sender.user_id..'/DelDistinguished'},},{{text = '‹ 𝖲𝗈U𝗋C𝖾 FoRc ›', url = 't.me/FoRx_TeAm'},},}}
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ الاساسيين : '..L..' ›', data = msg.sender.user_id..'/TheBasicsKADI'},},{{text = '‹ المنشئين : '..LL..' ›', data = msg.sender.user_id..'/OriginatorsKADI'},{text = '‹ المدراء : '..LLL..' ›', data = msg.sender.user_id..'/ManagersKADI'},},{{text = '‹ الادمنيه : '..LLLL..' ›', data = msg.sender.user_id..'/AddictiveKADI'},{text = '‹ المميزين : '..LLLLL..' ›', data = msg.sender.user_id..'/DelDistinguishedKADI'},},{{text = '‹ 𝖲𝗈U𝗋C𝖾 FoRc ›', url = 't.me/FoRx_TeAm'},},}}
return LuaTele.sendText(msg_chat_id,msg_id,'⌔︰هلا بك في قسم رتب المجموعة',"md",false, false, false, false, reply_markup)
--
...
local KADI = (Redis:get(itsRaumo..'Raumo:Num:Message:Edit'..msg.chat_id..msg.sender.user_id) or 0)
local KADI = (Redis:get(itsRaumo..'Raumo:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) or 0)
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ مسح سحكاتي : '..KADI..' ›', data = msg.sender.user_id..'/MsgDell'},{text = '‹ مسح رسائلي : '..KADI..' ›', data = msg.sender.user_id..'/MMsgDel'},},{{text = '‹ اخفاء الاوامر ›', data =msg.sender.user_id..'/'.. 'delAmr'}},{{text = '‹ 𝖲𝗈U𝗋C𝖾 FoRc ›', url = 't.me/FoRx_TeAm'},},}}
...
x = x + 1
Redis:srem(itsRaumo..'Raumo:Num:User:Pv',v) end end
...
local Get_Chat = LuaTele.getChat(v)
if Get_Chat.id then
local statusMem = LuaTele.getChatMember(Get_Chat.id,Raumo)
...
Redis:set(itsRaumo.."Raumo:Get:Reides:Commands:Group"..msg_chat_id..":"..'رس','مسح رسائلي')
Redis:set(itsRaumo.."Raumo:Get:Reides:Commands:Group"..msg_chat_id..":"..'ثانوي','رفع مطور ثانوي')
Redis:set(itsRaumo.."Raumo:Get:Reides:Commands:Group"..msg_chat_id..":"..'رد','اضف رد')
Redis:set(itsRaumo.."Raumo:Get:Reides:Commands:Group"..msg_chat_id..":"..'حذ','حذف رد')
Redis:set(itsRaumo.."Raumo:Get:Reides:Commands:Group"..msg_chat_id..":"..'#','مسح قائمه العام')
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ المطور ›', url = "t.me/"..UserSudo..""},},{{text = '‹ قناة السورس ›', url = 't.me/FoRx_TeAm'},{text = '‹ لتنصيب بوت ›', url = 't.me/NNlNNN'},},{{text = '‹ اضفني الى مجموعتك ›', url = 't.me/'..UserBot..'?startgroup=new'},},}}
...
Redis:sadd(itsRaumo..'Raumo:Num:User:Pv',msg.sender.user_id)  
local KADI = '⌔︰اهلا بك في قسم ‹ ردود الخاص ›\n⌔︰اضغط على الامر الذي تريد تنفيذه'
...
Redis:sadd(itsRaumo..'Raumo:Num:User:Pv',msg.sender.user_id)  
local KADI = '⌔︰اهلا بك في قسم ‹ السورس ›\n⌔︰اضغط على الامر الذي تريد تنفيذه'
...
Redis:sadd(itsRaumo..'Raumo:Num:User:Pv',msg.sender.user_id)  
local KADI = '⌔︰اهلا بك في قسم ‹ اسم البوت ›\n⌔︰اضغط على الامر الذي تريد تنفيذه'
...
Redis:sadd(itsRaumo..'Raumo:Num:User:Pv',msg.sender.user_id)  
local KADI = '⌔︰اهلا بك في قسم ‹ الاذاعة ›\n⌔︰اضغط على الامر الذي تريد تنفيذه'
...
Redis:sadd(itsRaumo..'Raumo:Num:User:Pv',msg.sender.user_id)  
local KADI = '⌔︰اهلا بك في قسم ‹ العام ›\n⌔︰اضغط على الامر الذي تريد تنفيذه'
...
Redis:sadd(itsRaumo..'Raumo:Num:User:Pv',msg.sender.user_id)  
local KADI = '⌔︰اهلا بك في قسم ‹ المطورين ›\n⌔︰اضغط على الامر الذي تريد تنفيذه'
...
return LuaTele.sendText(msg_chat_id,msg_id,Redis:get(itsRaumo.."Raumo:Start:Bot"),"md",false, false, false, false, reply_markup) end end
...
Redis:del(itsRaumo.."Raumo:List:Rd:Sudo") end
...
local inget = Redis:get(itsRaumo..'hmsabots'..ramsesadd[3]..data.sender_user_id)
...
Redis:set(itsRaumo..'hmsabots'..idnum..UserId_Info.id,username[1])
Redis:set(itsRaumo..'hmsabots'..idnum..data.sender_user_id,username[1]) end end
end
...
Redis:del(itsRaumo.."Raumo:PinMsegees:"..msg.chat_id) end
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
elseif msg.content.photo.sizes[2].photo.remote.id then
...
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(itsRaumo.."Raumo:PinMsegees:"..msg.chat_id) end end
...
if Message_Edit.sender.user_id == Raumo then
...
--
if Text and Text:match('(%d+)/MsHKADI') then
local UserId = Text:match('(%d+)/MsHKADI')
if tonumber(IdUser) == tonumber(UserId) then
local list = Redis:smembers(itsRaumo.."Raumo:allM"..data.chat_id)
for k,v in pairs(list) do
local Message = v
if Message then
t = "⌔︰تم حذف ‹ "..k.." › من الميديا"
LuaTele.deleteMessages(data.chat_id,{[1]= Message})
Redis:del(itsRaumo.."Raumo:allM"..data.chat_id) end end
if #list == 0 then
t = "⌔︰لا توجد ميديا في المجموعة"
end
...
local Text ='⌔︰تم اختيار المقطع الصوتي لك'
keyboard = {} 
keyboard.inline_keyboard = {{{text = '‹ مره اخرى ›', callback_data = IdUser..'/'.. 'Song'}},{{text='‹ 𝖲𝗈U𝗋C𝖾 FoRc ›',url="t.me/FoRx_TeAm"}}}
...
local Text ='⌔︰تم اختيار المتحركه لك'
keyboard = {} 
keyboard.inline_keyboard = {{{text = '‹ مره اخرى ›', callback_data = IdUser..'/'.. 'animation'}},{{text='‹ 𝖲𝗈U𝗋C𝖾 FoRc ›',url="t.me/FoRx_TeAm"}}}
local msg_id = Msg_id/2097152/0.5
...
local Text ='⌔︰تم اختيار الشعر لك'
keyboard = {} 
keyboard.inline_keyboard = {{{text = '‹ مره اخرى ›', callback_data = IdUser..'/'.. 'voice'}},{{text='‹ 𝖲𝗈U𝗋C𝖾 FoRc ›',url="t.me/FoRx_TeAm"}}}
local msg_id = Msg_id/2097152/0.5
...
local Text ='⌔︰تم اختيار الميمز لك'
keyboard = {} 
keyboard.inline_keyboard = {{{text = '‹ مره اخرى ›', callback_data = IdUser..'/'.. 'Memz'}},{{text='‹ 𝖲𝗈U𝗋C𝖾 FoRc ›',url="t.me/FoRx_TeAm"}}}
local msg_id = Msg_id/2097152/0.5
...
keyboard = {} 
keyboard.inline_keyboard = {{{text = '‹ مره اخرى ›', callback_data = IdUser..'/'.. 'Remix'}},{{text='‹ 𝖲𝗈U𝗋C𝖾 FoRc ›',url="t.me/FoRx_TeAm"}}}
local msg_id = Msg_id/2097152/0.5
...
local Text ='⌔︰تم اختيار الفلم لك'
keyboard = {} 
keyboard.inline_keyboard = {{{text = '‹ مره اخرى ›', callback_data = IdUser..'/'.. 'Movies'}},{{text='‹ 𝖲𝗈U𝗋C𝖾 FoRc ›',url="t.me/FoRx_TeAm"}}}
local msg_id = Msg_id/2097152/0.5
...
local Text ='⌔︰تم اختيار الانمي لك'
keyboard = {} 
keyboard.inline_keyboard = {{{text = '‹ مره اخرى ›', callback_data = IdUser..'/'.. 'Anime'}},{{text='‹ 𝖲𝗈U𝗋C𝖾 FoRc ›',url="t.me/FoRx_TeAm"}}}
local msg_id = Msg_id/2097152/0.5
...
local Text ='⌔︰تم اختيار الاغنيه لك'
keyboard = {} 
keyboard.inline_keyboard = {{{text = '‹ مره اخرى ›', callback_data = IdUser..'/'.. 'Mp'}},{{text='‹ 𝖲𝗈U𝗋C𝖾 FoRc ›',url="t.me/FoRx_TeAm"}}}
local msg_id = Msg_id/2097152/0.5
...
local Text ='⌔︰تم اختيار الصوره لك'
keyboard = {} 
keyboard.inline_keyboard = {{{text = '‹ مره اخرى ›', callback_data = IdUser..'/'.. 'Photos'}},{{text='‹ 𝖲𝗈U𝗋C𝖾 FoRc ›',url="t.me/FoRx_TeAm"}}}
local msg_id = Msg_id/2097152/0.5
...
local Text ='⌔︰تم اختيار المسلسل لك'
keyboard = {} 
keyboard.inline_keyboard = {{{text = '‹ مره اخرى ›', callback_data = IdUser..'/'.. 'Series'}},{{text='‹ 𝖲𝗈U𝗋C𝖾 FoRc ›',url="t.me/FoRx_TeAm"}}}
local msg_id = Msg_id/2097152/0.5
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(itsRaumo.."Raumo:Set:Manager:rd"..data.sender_user_id..":"..data.chat_id)
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(itsRaumo..'Raumo:GetTexting:DevRaumo'..data.chat_id..':'..data.sender_user_id)
return LuaTele.editMessageText(ChatId,Msg_id,'⌔︰تم الغاء الامر',"md",true) end end
--
if Text and Text:match('(%d+)/DelOwner') then
local UserId = Text:match('(%d+)/DelOwner')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(itsRaumo..'Raumo:GetOwner:OwnerRaumo'..data.chat_id..':'..data.sender_user_id)
return LuaTele.editMessageText(ChatId,Msg_id,'⌔︰تم الغاء الامر',"md",true) end end
--
if Text and Text:match('(%d+)/closerdControllerBot') then
local UserId = Text:match('(%d+)/closerdControllerBot')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(itsRaumo.."Raumo11:Set:Rd"..data.sender_user_id..":"..data.chat_id)
return LuaTele.editMessageText(ChatId,Msg_id,'⌔︰تم الغاء الامر',"md",true) end end
--
if Text and Text:match('(%d+)/closerd0bot') then
local UserId = Text:match('(%d+)/closerd0bot')
if tonumber(IdUser) == tonumber(UserId) then
local test = Redis:get(itsRaumo.."Raumo11:Text:Sudo:Bot"..data.sender_user_id..":"..data.chat_id)
Redis:del(itsRaumo..'Raumo11:Add:Rd:Sudo:Text'..test)
Redis:del(itsRaumo..'Raumo11:Add:Rd:Sudo:Text1'..test)
Redis:del(itsRaumo..'Raumo11:Add:Rd:Sudo:Text2'..test)
Redis:del(itsRaumo.."Raumo11:Set:Rd"..data.sender_user_id..":"..data.chat_id)
Redis:srem(itsRaumo.."Raumo11:List:Rd:Sudo", test)
...
--
if Text and Text:match('(%d+)/delrdKADIRbot') then
local UserId = Text:match('(%d+)/delrdKADIRbot')
if tonumber(IdUser) == tonumber(UserId) then
local test = Redis:get(itsRaumo.."Raumo11:Text:Sudo:Bot"..data.sender_user_id..":"..data.chat_id)
Redis:del(itsRaumo..'Raumo11:Add:Rd:Sudo:Text'..test)
Redis:del(itsRaumo..'Raumo11:Add:Rd:Sudo:Text1'..test)
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(itsRaumo.."Raumo11:Set:On"..data.sender_user_id..":"..data.chat_id)
return LuaTele.editMessageText(ChatId,Msg_id,'⌔︰تم الغاء الامر',"md",true) end end
---- KADI
if Text and Text:match('(%d+)/closerdManagers') then
local UserId = Text:match('(%d+)/closerdManagers')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(itsRaumo.."Raumo1:Set:Rd"..data.sender_user_id..":"..data.chat_id)
return LuaTele.editMessageText(ChatId,Msg_id,'⌔︰تم الغاء الامر',"md",true) end end
--
if Text and Text:match('(%d+)/closerd0') then
local UserId = Text:match('(%d+)/closerd0')
if tonumber(IdUser) == tonumber(UserId) then
local test = Redis:get(itsRaumo.."Raumo1:Text:Sudo:Bot"..data.sender_user_id..":"..data.chat_id)
Redis:del(itsRaumo..'Raumo1:Add:Rd:Sudo:Text'..test..data.chat_id)
Redis:del(itsRaumo..'Raumo1:Add:Rd:Sudo:Text1'..test..data.chat_id)
Redis:del(itsRaumo..'Raumo1:Add:Rd:Sudo:Text2'..test..data.chat_id)
Redis:del(itsRaumo..'Raumo1:Add:Rd:Sudo:Text3'..test..data.chat_id)
Redis:del(itsRaumo..'Raumo1:Add:Rd:Sudo:Text4'..test..data.chat_id)
Redis:del(itsRaumo.."Raumo1:Set:Rd"..data.sender_user_id..":"..data.chat_id)
Redis:srem(itsRaumo.."Raumo1:List:Rd:Sudo"..data.chat_id, test)
return LuaTele.editMessageText(ChatId,Msg_id,'⌔︰تم الغاء حفظ الرد',"md",true) end end
--
...
return LuaTele.editMessageText(ChatId,Msg_id,'⌔︰تم الغاء وحذف التخزين',"md",true) end end
--
if Text and Text:match('(%d+)/delrdKADIR') then
local UserId = Text:match('(%d+)/delrdKADIR')
if tonumber(IdUser) == tonumber(UserId) then
local test = Redis:get(itsRaumo.."Raumo1:Text:Sudo:Bot"..data.sender_user_id..":"..data.chat_id)
Redis:del(itsRaumo..'Raumo1:Add:Rd:Sudo:Text'..test..data.chat_id)
Redis:del(itsRaumo..'Raumo1:Add:Rd:Sudo:Text1'..test..data.chat_id)
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(itsRaumo.."Raumo1:Set:On"..data.sender_user_id..":"..data.chat_id)
return LuaTele.editMessageText(ChatId,Msg_id,'⌔︰تم الغاء الامر',"md",true) end end
-- KADI
if Text and Text:match('(%d+)/closeRules') then
local UserId = Text:match('(%d+)/closeRules')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(itsRaumo.."Raumo:Set:Rules:" .. data.chat_id .. ":" .. data.sender_user_id)
return LuaTele.editMessageText(ChatId,Msg_id,'⌔︰تم الغاء الامر',"md",true) end end
--
if Text and Text:match('(%d+)/closeDescription') then
local UserId = Text:match('(%d+)/closeDescription')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(itsRaumo.."Raumo:Set:Description:" .. data.chat_id .. ":" .. data.sender_user_id)
return LuaTele.editMessageText(ChatId,Msg_id,'⌔︰تم الغاء الامر',"md",true) end end
--
if Text and Text:match('(%d+)/closeWelcome') then
local UserId = Text:match('(%d+)/closeWelcome')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(itsRaumo.."Tshake:Welcome:Group" .. data.chat_id .. "" .. data.sender_user_id)  
return LuaTele.editMessageText(ChatId,Msg_id,'⌔︰تم الغاء الامر',"md",true) end end
--
if Text and Text:match('(%d+)/closeLINK') then
local UserId = Text:match('(%d+)/closeLINK')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(itsRaumo.."Raumo:Set:Link"..data.chat_id..""..data.sender_user_id) 
return LuaTele.editMessageText(ChatId,Msg_id,'⌔︰تم الغاء الامر',"md",true) end end
-- KADI
...
local UserId = Text:match('(%d+)/closerd')
if tonumber(IdUser) == tonumber(UserId) then
local test = Redis:get(itsRaumo.."Raumo:Text:Manager"..data.sender_user_id..":"..data.chat_id.."")
Redis:del(itsRaumo.."Raumo:Add:Rd:Manager:Gif"..test..data.chat_id)   
Redis:del(itsRaumo.."Raumo:Add:Rd:Manager:Vico"..test..data.chat_id)   
Redis:del(itsRaumo.."Raumo:Add:Rd:Manager:Stekrs"..test..data.chat_id)     
Redis:del(itsRaumo.."Raumo:Add:Rd:Manager:Text"..test..data.chat_id)   
Redis:del(itsRaumo.."Raumo:Add:Rd:Manager:Photo"..test..data.chat_id)
Redis:del(itsRaumo.."Raumo:Add:Rd:Manager:Video"..test..data.chat_id)
Redis:del(itsRaumo.."Raumo:Add:Rd:Manager:File"..test..data.chat_id)
Redis:del(itsRaumo.."Raumo:Add:Rd:Manager:Audio"..test..data.chat_id)
Redis:del(itsRaumo.."Raumo:Add:Rd:Manager:video_note"..test..data.chat_id)
Redis:del(itsRaumo.."Raumo:Set:Manager:rd"..data.sender_user_id..":"..data.chat_id)
Redis:srem(itsRaumo.."Raumo:List:Manager"..data.chat_id.."", test)
return LuaTele.editMessageText(ChatId,Msg_id,'⌔︰تم الغاء حفظ الرد',"md",true) end end
--
if Text and Text:match('(%d+)/closerD') then
local UserId = Text:match('(%d+)/closerD')
...
Rink = 1
elseif Redis:sismember(itsRaumo.."Raumo:DevelopersAS:Groups",IdUser)  then
Rink = 2
elseif Redis:sismember(itsRaumo.."Raumo:DevelopersQ:Groups",IdUser)  then
Rink = 3
elseif Redis:sismember(itsRaumo.."Raumo:Developers:Groups",IdUser)  then
Rink = 4
elseif Redis:sismember(itsRaumo.."Raumo:TheBasics:Group"..data.chat_id, IdUser) then
Rink = 5
elseif Redis:sismember(itsRaumo.."Raumo:Originators:Group"..data.chat_id, IdUser) then
Rink = 6
elseif Redis:sismember(itsRaumo.."Raumo:Managers:Group"..data.chat_id, IdUser) then
Rink = 7
elseif Redis:sismember(itsRaumo.."Raumo:Addictive:Group"..data.chat_id, IdUser) then
Rink = 8
elseif Redis:sismember(itsRaumo.."Raumo:Distinguished:Group"..data.chat_id, IdUser) then
Rink = 9
elseif Redis:sismember(itsRaumo.."Raumo:Cleaner:Group"..data.chat_id, IdUser) then
Rink = 10
else
Rink = 11
end
...
Redis:srem(itsRaumo.."Raumo:DevelopersAS:Groups", IdUser)
Redis:srem(itsRaumo.."Raumo:DevelopersQ:Groups", IdUser)
Redis:srem(itsRaumo.."Raumo:Developers:Groups", IdUser)
Redis:srem(itsRaumo.."Raumo:TheBasics:Group"..data.chat_id, IdUser)
Redis:srem(itsRaumo.."Raumo:Originators:Group"..data.chat_id, IdUser)
Redis:srem(itsRaumo.."Raumo:Managers:Group"..data.chat_id, IdUser)
Redis:srem(itsRaumo.."Raumo:Addictive:Group"..data.chat_id, IdUser)
Redis:srem(itsRaumo.."Raumo:Distinguished:Group"..data.chat_id, IdUser)
Redis:srem(itsRaumo.."Raumo:Cleaner:Group"..data.chat_id, IdUser)
...
if Get_Chat.id then
local statusMem = LuaTele.getChatMember(data.chat_id,Raumo)
...
Redis:srem(itsRaumo..'Raumo:ChekBotAdd',data.chat_id)
local keys = Redis:keys(itsRaumo..'*'..data.chat_id)
for i = 1, #keys do
Redis:del(keys[i]) end
...
if #list == 0 then
KADI = "⌔︰عذراً لا توجد ردود للمطور"
end
return LuaTele.editMessageText(ChatId,Msg_id,KADI,"md",true) end end
--
if Text and Text:match('(%d+)/RDs') then
local UserId = Text:match('(%d+)/RDs')
if tonumber(IdUser) == tonumber(UserId) then
local Rds = Redis:scard(itsRaumo.."Raumo:List:Rd:Sudo")
local list = Redis:smembers(itsRaumo.."Raumo:List:Rd:Sudo")
for k,v in pairs(list) do
Redis:del(itsRaumo.."Raumo:Add:Rd:Sudo:Gif"..v)   
Redis:del(itsRaumo.."Raumo:Add:Rd:Sudo:vico"..v)   
...
--
if Text and Text:match('(%d+)/RSoKADI') then
local UserId = Text:match('(%d+)/RSoKADI')
if tonumber(IdUser) == tonumber(UserId) then 
...
Redis:del(itsRaumo.."Raumo11:List:Rd:Sudo") end
return LuaTele.editMessageText(ChatId,Msg_id,'⌔︰تم حذف ‹ '..R..' › من ردود المتعدده العامه',"md",true) end end
--
if Text and Text:match('(%d+)/KADIcloseSo') then
local UserId = Text:match('(%d+)/KADIcloseSo')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(itsRaumo.."Raumo:Set:On"..data.sender_user_id..":"..data.chat_id)
return LuaTele.editMessageText(ChatId,Msg_id,'⌔︰تم الغاء الامر',"md",true) end end
--
if Text and Text:match('(%d+)/DevIDClose') then
local UserId = Text:match('(%d+)/DevIDClose')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(itsRaumo.."Raumo:AddSudosNew"..data.chat_id)
return LuaTele.editMessageText(ChatId,Msg_id,'⌔︰تم الغاء الامر',"md",true) end end
-- KADI --
if Text and Text:match('(%d+)/RdKADI') then
local UserId = Text:match('(%d+)/RdKADI')
if tonumber(IdUser) == tonumber(UserId) then 
local list = Redis:smembers(itsRaumo.."Raumo1:List:Rd:Sudo"..data.chat_id)
...
local UserId = Text:match('(%d+)/RdKADI')
if tonumber(IdUser) == tonumber(UserId) then
local R = Redis:scard(itsRaumo.."Raumo1:List:Rd:Sudo"..data.chat_id)
local list = Redis:smembers(itsRaumo.."Raumo1:List:Rd:Sudo"..data.chat_id)
for k,v in pairs(list) do  
Redis:del(itsRaumo.."Raumo1:Add:Rd:Sudo:Text"..v..data.chat_id) 
Redis:del(itsRaumo.."Raumo1:Add:Rd:Sudo:Text1"..v..data.chat_id) 
Redis:del(itsRaumo.."Raumo1:Add:Rd:Sudo:Text2"..v..data.chat_id) 
Redis:del(itsRaumo.."Raumo1:List:Rd:Sudo"..data.chat_id) end
...
if tonumber(IdUser) == tonumber(UserId) then 
local list = Redis:smembers(itsRaumo.."Raumo:List:Manager"..data.chat_id.."")
KADI = "⌔︰قائمة ردود المدير ↫ ⤈\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(list) do
if Redis:get(itsRaumo.."Raumo:Add:Rd:Manager:Gif"..v..data.chat_id) then
db = "متحركه 🎭"
elseif Redis:get(itsRaumo.."Raumo:Add:Rd:Manager:Vico"..v..data.chat_id) then
db = "بصمه 📢"
elseif Redis:get(itsRaumo.."Raumo:Add:Rd:Manager:Stekrs"..v..data.chat_id) then
db = "ملصق 🃏"
elseif Redis:get(itsRaumo.."Raumo:Add:Rd:Manager:Text"..v..data.chat_id) then
db = "رساله ✉"
elseif Redis:get(itsRaumo.."Raumo:Add:Rd:Manager:Photo"..v..data.chat_id) then
db = "صوره 🎇"
elseif Redis:get(itsRaumo.."Raumo:Add:Rd:Manager:Video"..v..data.chat_id) then
db = "فيديو 📹"
elseif Redis:get(itsRaumo.."Raumo:Add:Rd:Manager:File"..v..data.chat_id) then
db = "ملف 📁"
elseif Redis:get(itsRaumo.."Raumo:Add:Rd:Manager:Audio"..v..data.chat_id) then
db = "اغنيه 🎵"
elseif Redis:get(itsRaumo.."Raumo:Add:Rd:Manager:video_note"..v..data.chat_id) then
db = "فيديو نوت 🎥"
end
KADI = KADI..""..k.." - ‹ `"..v.."` › ↫ ‹"..db.."›\n"
end
if #list == 0 then
KADI = "⌔︰عذرا لا يوجد ردود للمدير في المجموعة"
end
LuaTele.editMessageText(ChatId,Msg_id,KADI, 'md', true) end end
--
if Text and Text:match('(%d+)/RD') then
local UserId = Text:match('(%d+)/RD')
if tonumber(IdUser) == tonumber(UserId) then
local R = Redis:scard(itsRaumo.."Raumo:List:Manager"..data.chat_id.."")
local list = Redis:smembers(itsRaumo.."Raumo:List:Manager"..data.chat_id.."")
for k,v in pairs(list) do
Redis:del(itsRaumo.."Raumo:Add:Rd:Manager:Gif"..v..data.chat_id)   
Redis:del(itsRaumo.."Raumo:Add:Rd:Manager:Vico"..v..data.chat_id)   
Redis:del(itsRaumo.."Raumo:Add:Rd:Manager:Stekrs"..v..data.chat_id)     
Redis:del(itsRaumo.."Raumo:Add:Rd:Manager:Text"..v..data.chat_id)   
Redis:del(itsRaumo.."Raumo:Add:Rd:Manager:Photo"..v..data.chat_id)
Redis:del(itsRaumo.."Raumo:Add:Rd:Manager:Video"..v..data.chat_id)
Redis:del(itsRaumo.."Raumo:Add:Rd:Manager:File"..v..data.chat_id)
Redis:del(itsRaumo.."Raumo:Add:Rd:Manager:video_note"..v..data.chat_id)
Redis:del(itsRaumo.."Raumo:Add:Rd:Manager:Audio"..v..data.chat_id)
Redis:del(itsRaumo.."Raumo:List:Manager"..data.chat_id) end
return LuaTele.editMessageText(ChatId,Msg_id,'⌔︰تم حذف ‹ '..R..' › من ردود المدير',"md",true)  end 
end
--
if Text and Text:match('(%d+)/KADIclose') then
local UserId = Text:match('(%d+)/KADIclose')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(itsRaumo.."Raumo:Set:Manager:rd"..data.sender_user_id..":"..data.chat_id)
return LuaTele.editMessageText(ChatId,Msg_id,'⌔︰تم الغاء الامر',"md",true) end end
-- KADI --
...
if Redis:sismember(itsRaumo.."Raumo:ChekBotAdd",data.chat_id) then return LuaTele.editMessageText(ChatId,Msg_id, '\n⌔︰المجموعة تم تفعيلها بالتأكيد' ,"md",true)  
else
...
if Info_Members.members[k].bot_info == nil then
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(itsRaumo.."Raumo:TheBas:Group"..data.chat_id,v.member_id.user_id) 
x = x + 1 end end
end
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رفع الادمنيه ›', data = UserId..'/'.. 'addAdmins@'..data.chat_id},{text = '‹ تفعيل الحمايه ›', data = UserId..'/'.. 'LockAllGroup@'..data.chat_id},},{{text = '‹ الاوامر ›', data = UserId..'/'.. 'helpall'},},{{text = '‹ غادر ›', data = UserId..'/'..'Yesbot'},{text = '‹ تعطيل ›', data = UserId..'/'..'disable'},},{{text = '‹ 𝖲𝗈U𝗋C𝖾 FoRc ›', url = 't.me/FoRx_TeAm'},},}}
Redis:sadd(itsRaumo.."Raumo:ChekBotAdd",data.chat_id)
Redis:set(itsRaumo.."Raumo:Status:Id"..data.chat_id,true) ;Redis:set(itsRaumo.."Raumo:Status:Reply"..data.chat_id,true) ;Redis:set(itsRaumo.."Raumo:Status:ReplySudo"..data.chat_id,true) ;Redis:set(itsRaumo.."Raumo:Status:BanId"..data.chat_id,true) ;Redis:set(itsRaumo.."Raumo:Status:SetId"..data.chat_id,true) 
...
local Get_Chat = LuaTele.getChat(data.chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(data.chat_id)
if not Redis:sismember(itsRaumo.."Raumo:ChekBotAdd",data.chat_id) then return LuaTele.editMessageText(ChatId,Msg_id, '\n⌔︰المجموعة تم تعطيلها بالتأكيد',"md",true)  
else
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ غادر ›', data = UserId..'/'..'Yesbot'},{text = '‹ تفعيل ›', data = UserId..'/'..'activation'},},{{text = '‹ 𝖲𝗈U𝗋C𝖾 FoRc ›', url = 't.me/FoRx_TeAm'},},}}
Redis:srem(itsRaumo.."Raumo:ChekBotAdd",data.chat_id)
...
if tonumber(IdUser) == tonumber(UserId) then 
local Get_Chat = LuaTele.getChat(data.chat_id) 
local GetLink = Redis:get(itsRaumo.."Raumo:Group:Link"..data.chat_id) 
if GetLink then
...
if tonumber(IdUser) == tonumber(UserId) then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اوامر الادمنيه', data = IdUser..'/help2'},},{{text = 'اوامر المدراء', data = IdUser..'/help3'}, {text = 'اوامر المنشئين', data = IdUser..'/help4'},},{{text = 'اوامر المطورين', data = IdUser..'/help5'}, {text = 'العاب البوت', data = IdUser..'/help6'},},{{text = '‹ القائمه الرئيسيه › ', data = IdUser..'/helpall'},},{{text = '‹ 𝖲𝗈U𝗋C𝖾 FoRc ›', url = 't.me/FoRx_TeAm'},},}}
local TextHelp = [[*
...
if tonumber(IdUser) == tonumber(UserId) then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اوامر الحمايه', data = IdUser..'/help1'},},{{text = 'اوامر المدراء', data = IdUser..'/help3'}, {text = 'اوامر المنشئين', data = IdUser..'/help4'},},{{text = 'اوامر المطورين', data = IdUser..'/help5'}, {text = 'العاب البوت', data = IdUser..'/help6'},},{{text = '‹ القائمه الرئيسيه › ', data = IdUser..'/helpall'},},{{text = '‹ 𝖲𝗈U𝗋C𝖾 FoRc ›', url = 't.me/FoRx_TeAm'},},}}
local TextHelp = [[*
⌔︰اوامر ادمنية ↫ ⤈
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
⌔︰رفع • تنزيل ↫ مميز
...
if tonumber(IdUser) == tonumber(UserId) then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اوامر الحمايه', data = IdUser..'/help1'}, {text = 'اوامر الادمنيه', data = IdUser..'/help2'},},{{text = 'اوامر المنشئين', data = IdUser..'/help4'},},{{text = 'اوامر المطورين', data = IdUser..'/help5'}, {text = 'العاب البوت', data = IdUser..'/help6'},},{{text = '‹ القائمه الرئيسيه › ', data = IdUser..'/helpall'},},{{text = '‹ 𝖲𝗈U𝗋C𝖾 FoRc ›', url = 't.me/FoRx_TeAm'},},}}
local TextHelp = [[*
⌔︰اوامر المدراء ↫ ⤈
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
⌔︰رفع • تنزيل ↫ ادمن
...
if tonumber(IdUser) == tonumber(UserId) then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اوامر الحمايه', data = IdUser..'/help1'}, {text = 'اوامر الادمنيه', data = IdUser..'/help2'},},{{text = 'اوامر المدراء', data = IdUser..'/help3'},},{{text = 'اوامر المطورين', data = IdUser..'/help5'}, {text = 'العاب البوت', data = IdUser..'/help6'},},{{text = '‹ القائمه الرئيسيه › ', data = IdUser..'/helpall'},},{{text = '‹ 𝖲𝗈U𝗋C𝖾 FoRc ›', url = 't.me/FoRx_TeAm'},},}}
local TextHelp = [[*
...
if tonumber(IdUser) == tonumber(UserId) then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اوامر الحمايه', data = IdUser..'/help1'}, {text = 'اوامر الادمنيه', data = IdUser..'/help2'},},{{text = 'اوامر المدراء', data = IdUser..'/help3'}, {text = 'اوامر المنشئين', data = IdUser..'/help4'},},{{text = 'العاب البوت', data = IdUser..'/help6'},},{{text = '‹ القائمه الرئيسيه › ', data = IdUser..'/helpall'},},{{text = '‹ 𝖲𝗈U𝗋C𝖾 FoRc ›', url = 't.me/FoRx_TeAm'},},}}
local TextHelp = [[*
...
if tonumber(IdUser) == tonumber(UserId) then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اوامر الحمايه', data = IdUser..'/help1'}, {text = 'اوامر الادمنيه', data = IdUser..'/help2'},},{{text = 'اوامر المدراء', data = IdUser..'/help3'}, {text = 'اوامر المنشئين', data = IdUser..'/help4'},},{{text = 'اوامر المطورين', data = IdUser..'/help5'},},{{text = '‹ القائمه الرئيسيه › ', data = IdUser..'/helpall'},},{{text = '‹ 𝖲𝗈U𝗋C𝖾 FoRc ›', url = 't.me/FoRx_TeAm'},},}}
local TextHelp = [[*
⌔︰قائمه الالعاب البوت ↫ ⤈
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
...
if tonumber(IdUser) == tonumber(UserId) then
local MMsgDel = (Redis:get(itsRaumo..'Raumo:Num:Message:User'..data.chat_id..':'..UserId) or 0)
Redis:del(itsRaumo..'Raumo:Num:Message:User'..data.chat_id..':'..UserId) 
...
if tonumber(IdUser) == tonumber(UserId) then
local MsgDell = (Redis:get(itsRaumo..'Raumo:Num:Message:Edit'..data.chat_id..UserId) or 0)
Redis:del(itsRaumo..'Raumo:Num:Message:Edit'..data.chat_id..UserId)
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'Rgg'},},}}
...
LuaTele.editMessageText(ChatId,Msg_id,Text, 'md', false, false, reply_markup) end end 
-- KADI
if Text and Text:match('(%d+)/TheBasicsKADI') then
local UserId = Text:match('(%d+)/TheBasicsKADI')
if tonumber(IdUser) == tonumber(UserId) then 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'RgoAKADI'},},}}
local Info_Members = Redis:smembers(itsRaumo.."Raumo:TheBasics:Group"..data.chat_id) 
...
--
if Text and Text:match('(%d+)/OriginatorsKADI') then
local UserId = Text:match('(%d+)/OriginatorsKADI')
if tonumber(IdUser) == tonumber(UserId) then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'RgoAKADI'},},}}
local Info_Members = Redis:smembers(itsRaumo.."Raumo:Originators:Group"..data.chat_id) 
...
return LuaTele.editMessageText(ChatId,Msg_id,ListMembers,"md",true, false, reply_markup) end end
--
if Text and Text:match('(%d+)/ManagersKADI') then
local UserId = Text:match('(%d+)/ManagersKADI')
if tonumber(IdUser) == tonumber(UserId) then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'RgoAKADI'},},}}
local Info_Members = Redis:smembers(itsRaumo.."Raumo:Managers:Group"..data.chat_id) 
...
return LuaTele.editMessageText(ChatId,Msg_id,ListMembers,"md",true, false, reply_markup) end end
--
if Text and Text:match('(%d+)/AddictiveKADI') then
local UserId = Text:match('(%d+)/AddictiveKADI')
if tonumber(IdUser) == tonumber(UserId) then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'RgoAKADI'},},}}
local Info_Members = Redis:smembers(itsRaumo.."Raumo:Addictive:Group"..data.chat_id) 
...
return LuaTele.editMessageText(ChatId,Msg_id,ListMembers,"md",true, false, reply_markup) end end
--
if Text and Text:match('(%d+)/DelDistinguishedKADI') then
local UserId = Text:match('(%d+)/DelDistinguishedKADI')
if tonumber(IdUser) == tonumber(UserId) then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'RgoAKADI'},},}}
local Info_Members = Redis:smembers(itsRaumo.."Raumo:Distinguished:Group"..data.chat_id) 
...
return LuaTele.editMessageText(ChatId,Msg_id,ListMembers,"md",true, false, reply_markup) end end
--
if Text and Text:match('(%d+)/RgoAKADI') then
local UserId = Text:match('(%d+)/RgoAKADI')
if tonumber(IdUser) == tonumber(UserId) then
local Text = "*\n⌔︰هلا بك في قسم رتب المجموعة*"
local L = Redis:scard(itsRaumo.."Raumo:TheBasics:Group"..data.chat_id) 
local LL = Redis:scard(itsRaumo.."Raumo:Originators:Group"..data.chat_id) 
local LLL = Redis:scard(itsRaumo.."Raumo:Managers:Group"..data.chat_id)
local LLLL = Redis:scard(itsRaumo.."Raumo:Addictive:Group"..data.chat_id)  
local LLLLL = Redis:scard(itsRaumo.."Raumo:Distinguished:Group"..data.chat_id)
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ الاساسيين : '..L..' ›', data =IdUser..'/'.. 'TheBasicsKADI'},},{{text = '‹ المنشئين : '..LL..' ›', data =IdUser..'/'.. 'OriginatorsKADI'},{text = '‹ المدراء : '..LLL..' ›', data =IdUser..'/'.. 'ManagersKADI'},},{{text = '‹ الادمنيه : '..LLLL..' ›', data =IdUser..'/'.. 'AddictiveKADI'},{text = '‹ المميزين : '..LLLLL..' ›', data =IdUser..'/'.. 'DelDistinguishedKADI'},},{{text = '‹ اخفاء الاوامر ›', data =IdUser..'/'.. 'delAmr'}},}}
...
if tonumber(IdUser) == tonumber(UserId) then
local KADI = (Redis:get(itsRaumo..'Raumo:Num:Message:Edit'..data.chat_id..UserId) or 0)
local KADI = (Redis:get(itsRaumo..'Raumo:Num:Message:User'..data.chat_id..':'..UserId) or 0)
local Text = "\n⌔︰من خلال الازرار يمكنك مسح رسائلك وسحكاتك"
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ مسح سحكاتي : '..KADI..' ›', data =IdUser..'/'.. 'MsgDell'},{text = '‹ مسح رسائلي : '..KADI..' ›', data =IdUser..'/'.. 'MMsgDel'},},{{text = '‹ اخفاء الاوامر ›', data =IdUser..'/'.. 'delAmr'}},{{text = '‹ 𝖲𝗈U𝗋C𝖾 FoRc ›', url = 't.me/FoRx_TeAm'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Text, 'md', false, false, reply_markup) end end 
-- KADI
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(itsRaumo.."Raumo:TheBasicsQ:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(itsRaumo.."Raumo:Cleaner:Group"..ChatId) 
